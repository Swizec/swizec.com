...
Business follows an S-curve. Starts off slow, grows super fast, then slows down again. [Your timing matters](https://swizec.com/blog/when-to-join-and-leave-a-company-project-or-trend/).
