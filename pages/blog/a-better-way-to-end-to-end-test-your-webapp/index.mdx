...
categories: "Testing, TypeScript, AI, Frontend Engineering"
...
But there's an idea I like from the server world for testing against 3rd party APIs – [Ruby VCR](https://github.com/vcr/vcr). Instead of carefully mocking an API, just record what it does!
