...
categories: "Canada, Google, Lego, Travel + Events"
...
[I spent last week in Canada](https://swizec.com/blog/canada-eh/) interviewing with [Shopify](http://shopify.com "Shopify").

## Shopify

![Lounge mural](https://swizec.com/wp-content/uploads/2013/04/lounge-mural.jpg "Lounge mural")

It all started a few months ago when [I wrote a blogpost ranting about the terrible engineering practices](https://swizec.com/blog/my-very-own-daily-wtf/) of one of my clients and how I was hired to swoop in and fix their codebase. A few days later I get an email from somebody at Shopify along the lines of _"Hey, one of our developers saw your post, then saw your Github. I think we're doing some stuff you'd find interesting. Wanna talk?"_
...
[Just like at Google](https://swizec.com/blog/a-google-phone-interview/), there were two technical Skype calls where I got to talk with two different engineers working on extremely different stuff. I think this part was about figuring out whether I'm more of a frontend guy or more of a backend guy.
...
Very unlike Google, [where I was cooped up in a small room with a whiteboard](https://swizec.com/blog/inside-a-google-onsite-interview/) all day and forced to produce executable code without a computer. Sure those were fun and awesome, but they were all the same.
