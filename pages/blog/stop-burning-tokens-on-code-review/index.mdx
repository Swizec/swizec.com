...
description: "I've been experimenting with different approaches to build a system where humans and agents can ship fast safely. Think I've found something that works – custom linters. "
