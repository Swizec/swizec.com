...
Reid Hoffman, founder of linkedin, has a great line in a [Masters of Scale podcast](https://mastersofscale.com/selina-tobaccowala-let-fires-burn/) – _"You gotta let fires burn. If you try to catch every fire, you'll miss the biggest opportunities"_.
...
You can't do everything – there isn't time – but you _can_ try to always work on the next highest priority item. This is true on the individual level, the team level, and all the way up the whole company.
