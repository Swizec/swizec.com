...
One of the inventors of the PNG format is from Slovenia, and he also gave a talk at that Barcamp . We didn't meet that day, but I blogged about [liking his talk](https://swizec.com/blog/my-barcamp-ljubljana-report/). A few years later, we connected via email and stayed in touch.
...
It took 1444 posts, but eventually my first taste of broader fame came when [I was the first to shit on Apple Ping](https://swizec.com/blog/apples-ping-is-a-big-pile-of-steaming-dung/). This was my first post to make the frontpage of HackerNews.
...
That winter I wrote [Why Programmers Work At Night](https://swizec.com/blog/why-programmers-work-at-night-2/). It's the most popular thing I've ever written. I even turned it into a book, which I still haven't finished, but anyway.
