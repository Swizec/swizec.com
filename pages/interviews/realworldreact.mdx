...
[Real World React – Sep 22, 2022](https://www.youtube.com/watch?v=NAbEo2_6Us4&ab_channel=RealWorldReact)
...
- Is leadership a quality that is a prerequisite for becoming a senior engineer?
...
"Junior or associate engineers usually are people who can write code. They can write really good code! It's not so much about how long it takes them, but they need more guidance and more guardrails" - Swizec Teller
...
"Senior engineer is more like project focused, making sure a project gets done well and on time rather than constructing a team" - Swizec Teller
...
"Turns out turning a 1 million lines of code codebase from JavaScript to TypeScript is not quick" - Swizec Teller
