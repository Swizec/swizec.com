...
Every team slows down as it grows. More people, more code, more meetings, less shipping. It doesn't have to be that way. These essays are the thinking behind my book [Scaling Fast](https://scalingfastbook.com).
...
AI writes most of my code these days. The hard part was never the typing — it's knowing what to build and recognizing when the machine is wrong. Lessons from using AI in production, not demos.
...
I've been building web backends since ~2004 when they were just called websites. With these essays I want to share the hard lessons learned.
