...
"The thing that a lot of software engineers really like to forget is that well-maintained software is not just something that follows some textbook idea of perfection. First and foremost, it does have to solve an actual business problem that real people have" - Swizec Teller
...
"What usually happens is that if you're in a startup and you have time to just focus on technical debt, that's usually a bad sign because it means the business has stopped innovating" - Swizec Teller

"It kind of ends up being an ongoing process where you are always looking for ways to improve technical debt while you're working on a feature in a related space" - Swizec Teller
