...
**The audiobook** is 3h 32min of audio narrated by the author, Swizec, with exclusive commentary and additional insights not available in the pdf/epub edition. Here's a sample:
...
**Will there be an audiobook?** Yes! For those of us who have a hard time sitting down to read, the audiobook is now available with 3h 32min of audio narrated by the author.
...
**Why does the price go up for every 100 purchases?** To nudge you from "maybe one day" to "yes, now". As the price grows, I add new goodies or introduce packages to keep the core lessons affordable.
