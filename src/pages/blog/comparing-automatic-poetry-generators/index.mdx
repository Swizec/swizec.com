...
![Walt Whitman's use of free verse became apprec...](./img/Walt-Whitmans-use-of-free-verse-became-apprec5jbibb.jpeg)
...
The many attempts at making a computer write [poetry](http://en.wikipedia.org/wiki/Poetry) can be put in four categories: word salad, template and grammar-based, form-aware [generators](http://en.wikipedia.org/wiki/Electric_generator), poetry generation systems.

## 1. [Word Salad](http://en.wikipedia.org/wiki/Word_salad) generators
...
All [1] in the [2]
I [3][4] [5] in the [6][7] the [8] has [9]
...
![Ishar Singh 'Ishar' Bhaiya reciting a poem](./img/Ishar-Singh-Ishar-Bhaiya-reciting-a-poem89d020.jpeg)
...
Fun fact: the only two computer systems to have published poetry ([RACTER](http://en.wikipedia.org/wiki/Racter) and PROSE) were of this type.
...
Good examples of these sort of systems are ASPERA and COLIBRI, which use [case-based reasoning](http://en.wikipedia.org/wiki/Case-based_reasoning) to produce good looking Spanish poetry.
...
![The Poet Tree in Cabbagetown Toronto](./img/The-Poet-Tree-in-Cabbagetown-Torontohhe106.jpeg)

So there you go, the whole field of [automatic poetry](http://en.wikipedia.org/wiki/Surrealist_techniques) generation laid out before your eyes. The minimal overlap between different systems clearly shows that this field is virtually nonexistent since not much consensus has been reached on how this should be done ... since the early 1970's.
