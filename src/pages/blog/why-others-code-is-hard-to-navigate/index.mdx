...
What happens when others in your family can store things? What if they disagree about what category it falls under? Is the wonderful <https://en.wikipedia.org/wiki/The_Thrilling_Adventures_of_Lovelace_and_Babbage[Lovelace> & Babbage by Stoney Babua] more of a sci-fi, historical fiction, educational fanfic, or comic book?
...
Whether you like categories or searching may be generational. In <https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z[File> not Found] for The Verge, Monica Chin writes about conundrum college professors are struggling with – young students don't understand folders. Why organize your research when everything is searchable?
