...
content_upgrade: ServerlessHandbookLaunch
hero: ./img/screenshot-1615309454713.png
---

import { ServerlessHandbookLaunch } from "../../../components/FormCK/ContentUpgrades"

Friend, ever seen this meme about the bloat of VC-backed startups?

![](https://i.imgur.com/lSzYypg.jpg)
...
We'll talk about that on Friday. Today I wanted to talk about *my* AWS bill. A whopping $12 per month. 😛
...
![Sketch of how the Gumroad hook works](https://i.imgur.com/bjz0AJo.png)
...
![TechLetter app being wonderful](https://i.imgur.com/AseKh6a.gif)
...
![Spark Joy widgets](https://i.imgur.com/waSdmgR.png)
...
![Lambda is free](https://i.imgur.com/HNy6DeB.png)
