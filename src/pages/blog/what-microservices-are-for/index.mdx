...
![Example of concern-based architecture](./img/Example-of-concern-based-architecture4fe0hb.png "Example of concern-based architecture")
...
![Control flow to add a comment](./img/Control-flow-to-add-a-commentf4ch4i.png "Control flow to add a comment")
...
![Problem solved](./img/problem_solved.png "Problem solved")
...
![Turning modules into microservices](./img/Turning-modules-into-microservicesd31ffh.png "Turning modules into microservices")
