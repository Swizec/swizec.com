...
---
Lots of folks were curious how I connect Gummroad and Auth0 on [my custom course platform](https://swizec.com/blog/why-and-how-i-built-my-own-course-platform/swizec/9330) so here's a short tutorial. The same approach works if you swap Gumroad out for Stripe ✌️
