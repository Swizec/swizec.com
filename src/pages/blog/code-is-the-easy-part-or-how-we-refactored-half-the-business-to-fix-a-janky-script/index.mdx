...
description: "This is a war story. The kind that puts timezones to shame. It's probably the most engineeringest thing I've ever done."
...
I mentioned Billing Entities as the core fix. This took refactoring half the business (this is hyperbole).
...
Invoicing feels less stressful, the finance team is happy, and we've got both anecdotal and hard data to show users love their new superpowers.
