...
Ever had to debug a compiler {{ subscriber.first_name | truncatewords: 1, "" | capitalize }}? It's hard.Typical engineering wisdom goes that if you blame the compiler, you're wrong. You messed up and can't figure it out and it is \_not the compiler's fault\_.
...
That's the general idea. You can read about compilers in more detail in my [LOLCODE-to-JavaScript compiler](https://swizec.com/blog/lolcode-to-javascript-compiler-babel-macro/swizec/9083) article.
