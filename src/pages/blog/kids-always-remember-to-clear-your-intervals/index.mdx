...
![Completely random graph](./img/images-23704.png)
...
So you move data generation into the backend and hook it up with [socket.io](http://socket.io/). Then you make a function that generates one datapoint every `250ms`.
...
![Moving random graph](./img/images-23705.gif)

Yay! It moves!

But still too random to look realistic. A [CPU](http://en.wikipedia.org/wiki/Central_processing_unit) that behaves like that is in serious trouble!
...
![Fixed random graph, 1](./img/images-23706.gif)

Or like this:

![Fixed random graph, 2](./img/images-23707.gif)

Or even like this:

![Fixed random graph, 3](./img/images-23708.gif)
...
![Moving graph, good](./img/images-23710.gif)
