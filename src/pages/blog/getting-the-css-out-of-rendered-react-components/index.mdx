...
---
Here&#x27;s a fun problem for ya: How do you get the CSS from a rendered React component?Right-click, inspect element, see it in dev tools. D&#x27;oh 🙄What about programmatically?![thinking giphy](./img/media-kPtv3UIPrv36cjxqLs-giphy.gif)
