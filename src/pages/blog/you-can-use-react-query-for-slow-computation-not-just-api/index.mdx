...
We kept the same core of our code – turn CSV into a file, ask Papa to parse it.

Because Papa is an older library, we had to wrap it in a promise. Makes it work better with async/await.
