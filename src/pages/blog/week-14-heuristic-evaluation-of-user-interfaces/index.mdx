...
categories: "52papers52weeks, Heuristic, Heuristic evaluation, Human-computer interaction, Jakob Nielsen, Learning, Personal, Usability, User interface, Users, Papers"
...
[User interfaces](http://en.wikipedia.org/wiki/User_interface) are hard. So hard in fact that a friend of mine recently spent 45 minutes on hold with the IRS only to be told _"Sorry, we're too busy. Call back later."_. He never even spoke to a real person.
...
There are, in fact, many. But in 1990 [Jakob Nielsen](http://en.wikipedia.org/wiki/Jakob_Nielsen_%28usability_consultant%29) and Rolf Molich published a paper called [_Heuristic Evaluation of User Interfaces_](https://docs.google.com/viewer?url=http%3A%2F%2Fmestrado-watinha.googlecode.com%2Fsvn%2Ftrunk%2Fhci%2Fmonografia%2FartigosUtilizados%2Frevisao%2Fp249-nielsenAvaHeu.pdf) that describes a cheap way of accurately finding most if not all [usability](http://en.wikipedia.org/wiki/Usability) problems in your interface.
...
![Summary of experiments](./img/images-8250.png)
...
![Proportion of problems discovered](./img/images-8252.png)
...
![Individual differences in ability](./img/Individual-differences-in-ability3c4b98.png)
...
![Proportion of usability problems found](./img/images-8254.png)
...
![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=0f82c821-0d44-4a60-8104-0025d8f158c6)
