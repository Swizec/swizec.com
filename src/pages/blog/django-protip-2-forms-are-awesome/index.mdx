...
Welcome to another installment of Swizec's [Django](http://www.djangoproject.com "Django (web framework)") protip. Previously we discussed a better way to [structure your django apps](https://swizec.com/blog/django-protip-1-a-better-app-structure/swizec/1386), but nobody cared about that because everybody is rather silly. This time we'll be talking about how awesome forms are and why you should be using them for pretty much everything. At the end, I'll show you some neat [tips and tricks](http://en.wikipedia.org/wiki/Tips_%26_Tricks "Tips & Tricks") I discovered during my Django Epiphany.
...
- [Small trick for seamless base64 password storage in django](https://swizec.com/blog/small-trick-for-seamless-base64-password-storage-in-django/swizec/1378) (swizec.com)
