...
![Trisk - a conversational robot](./img/~dkroy-img-research-feature-trisk.jpg)
...
1.  [Content determination](http://en.wikipedia.org/wiki/Content_determination) - what you're going to say, based on knowledge, communicative goal and user's expectations
...
![Three reiter pipeline architecture](https://swizec.com/wp-content/uploads/2012/05/three-reiter-pipeline-architecture.png)
...
[![NLG architectures](https://swizec.com/wp-content/uploads/2012/05/NLG-architectures.png)](https://swizec.com/wp-content/uploads/2012/05/NLG-architectures.png)
...
- ![A search space](https://graphvisualizer.org/images/examples/nc_gilbert.png)
...
- **systemic search**- go through all possible solutions and find the best one. Problem with this approach is that it can take a while to finish, but you always get the most optimal solutionFour main ways exist to implement this: chart generation (use charts to define the search space and go from there), [truth maintenance systems](http://en.wikipedia.org/wiki/Reason_maintenance) (have assumptions, make sure they stay true), "redefining the search problem" (a lot of invalid choices can be pruned out based on linguistic knowledge, which helps with the explosive search space size), constraint logic programming (everyone who's done a prolog course has seen this I think)
...
[![Author-reviewer model](https://swizec.com/wp-content/uploads/2012/05/author-reviewer-model.png)](https://swizec.com/wp-content/uploads/2012/05/author-reviewer-model.png)
...
![A jewelry](./img/-sxeHKJFWoSY-TahM2cBBSoI-AAAAAAAAA9U-velz_DWTJdg-s1600-antique-jewelry-antique-jewellery.jpg)
