...
categories: "commentary, food for thought, Human-computer interaction, society, Uncategorized, Usability"
hero: ../../../defaultHero.jpg
---

- [![Albert Einstein during a lecture in Vienna in 1921](./img/Albert-Einstein-during-a-lecture-in-Vienna-in-19215g89h5.jpeg](http://commons.wikipedia.org/wiki/Image:Einstein1921_by_F_Schmutzer_2.jpg)
...
- PEBCAK/PEBKAC Error "problem exists between chair and keyboard" - [ID10T](http://en.wikipedia.org/wiki/ID-Ten-T_Error) Error (via @foulbastard)
- Or [PICNIC](http://en.wikipedia.org/wiki/PEBKAC). Problem In Chair Not In Computer (via @kapkap)
...
- [![Model of the Human Processor](./img/Model-of-the-Human-Processor5382ff.jpeg](http://commons.wikipedia.org/wiki/Image:HumanProcessorModel.jpg)

Image via [Wikipedia](http://commons.wikipedia.org/wiki/Image:HumanProcessorModel.jpg)

An old saying goes, or maybe I just made it up, that The tool is only as good as the person using it, which seems like a terrible example to use, but hear me out. Notice that it doesn't say the tool is good, neither does it say that the tool is brilliant, it says the tool is used.
...
Well next time that happens, stop for a moment and think: How often am I the stupid user? Chances are the answer is Quite frequently.
