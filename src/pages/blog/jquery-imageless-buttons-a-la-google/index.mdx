...
THE BUTTONS NOW WORK! Please go to [jQuery imageless buttons a la Google take two](https://swizec.com/blog/jquery-imageless-buttons-a-la-google-take-two/2/429).
...
I'm afraid my blog won't let me inject css styling and such so here's a screenshot of what it looks like: ![](https://swizec.com/code/styledButton/example.png)

To see a live demo and download the code go to the[jQuery imageless buttons](https://swizec.com/code/styledButton/) page.
