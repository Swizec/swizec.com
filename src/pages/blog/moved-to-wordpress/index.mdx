...
categories: "blog, life, Uncategorized"
hero: ../../../defaultHero.jpg
---

- [Dare to Be Stupid album cover](http://en.wikipedia.org/wiki/Image:Weird_Al_Yankovic_-_Dare_to_Be_Stupid.jpg)
...
Using wordpress will also allow me to poke around the [Zemanta](http://www.zemanta.com) plugin so I can see if it's really as great as they keep telling me it is. So far I've only ever seen in it in action on [Jure Cuhalev](http://www.jurecuhalev.com/blog)'s blog where it seemed ... somewhat quirky. Will see how it performs in my neck of the woods.
...
[Reblog this post [with Zemanta]](http://reblog.zemanta.com/zemified/3a41f717-f8b8-401f-ad3d-439c38d97552/)
