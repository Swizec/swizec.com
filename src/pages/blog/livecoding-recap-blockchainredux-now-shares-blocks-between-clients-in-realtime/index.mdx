...
![Initializing the blockchain from Firebase](https://swizec.com/blog/wp-content/uploads/2018/04/firebase-blockchain-init.png)
...
![Listen for the next block](https://swizec.com/blog/wp-content/uploads/2018/04/wait-for-next-block.png)
