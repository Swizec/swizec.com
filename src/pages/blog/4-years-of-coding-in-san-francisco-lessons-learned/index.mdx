...
import FormCK, { LearnedSomethingNew } from '../../../components/FormCK'

![](./img/blog-wp-content-uploads-2019-04-11084974_642240412543178_1151569054_n.jpg)

<FormCK
    copyBefore={<LearnedSomethingNew />}
    submitText="Improve my career ?">
        <h2>Get thoughtful letters?</h2>
        <p>“Man, I love your way of writing these newsletters. Often very relatable and funny perspectives about the mundane struggles of a dev. Lightens up my day.  </p>
</FormCK>
