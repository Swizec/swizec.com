...
I still remember the heated arguments I'd have with my high school professors about dynamic languages. What do you mean python isn't a _real_ language? What's wrong with you!? [Dynamic languages](http://en.wikipedia.org/wiki/Dynamic_programming_language) are the coolest thing ever!

Some kids fight about curfews and school rules, I fought about [scripting languages](http://en.wikipedia.org/wiki/Scripting_language) being just as "real" as the likes of C and Pascal. That was ten years ago - dynamic languages were all the rage and I just started exploring the world of programming beyond what my mentors laid out in front of me.
...
The situation is just as bad in other dynamic languages. [JavaScript](http://en.wikipedia.org/wiki/JavaScript) is particularly famous for its weird handling of data types.

[https://twitter.com/lagergren/status/337484475204255744](https://twitter.com/lagergren/status/337484475204255744)
...
I don't want to remember the atrocities I've committed in [PHP](http://www.php.net) just to convince it that yes, I do know what I'm doing, yes I do want that variable to behave like it's a particular type.
...
![Dynamic languages](https://www.filepicker.io/api/file/8xojSjy5S9CpVtWes2dl)
...
But we did get away from the whole `int a` nonsense. And we did get fancy [REPL](http://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop)'s. And we did get away from the write-compile-run cycle.
...
[Scala](http://www.scala-lang.org/) and [Haskell](http://haskell.org) have everything we've always wanted from a dynamic language. You never have to spell out a variable's name, the compiler often knows better than you do anyway, and there is a REPL you can use to prototype things.

But unlike dynamic languages you can rely on _everything_. All the benefits of [static type](http://en.wikipedia.org/wiki/Type_system) analysis, most of the benefits of dynamic languages. Hell, you can get rid of the write-compile-run cycle with a simple bash script that compiles your code before running it.
...
![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=83b08eef-ef3e-4b96-9d39-cf7b256a3e51)
