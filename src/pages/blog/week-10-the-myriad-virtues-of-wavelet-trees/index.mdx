...
It talks about using Wavelet Trees as a stand-alone [compression algorithm](http://en.wikipedia.org/wiki/Data_compression) and as on top of some popular string encodings like run-length encoding, [move-to-front transform](http://en.wikipedia.org/wiki/Move-to-front_transform) and the [Burrows-Wheeler transform](http://en.wikipedia.org/wiki/Burrows%E2%80%93Wheeler_transform). The results are pretty cool, but not revolutionary. The authors just improved some additive terms in lower and upper bounds of achievable compression.
...
![Wavelet tree for the string "abracadabra"](./img/images-6200.png)

Phew, that was simple. Now we just need the transforms.

We can do to lower the [entropy](http://en.wikipedia.org/wiki/Entropy) of a string to make it easier to compress. Entropy is a measure of how disorganised our string is. You can also think of it as information density.
...
![BANANA Burrows-Wheeler transform](./img/images-6213.png)
...
![0-th order entropy for highly compressible strings](./img/images-6217.png)
...
![Skewed Wavelet Tree](./img/images-6223.png)
...
![C<sub>Gap</sub> bound](./img/images-6224.png)
...
![ge_wt bound](./img/images-6225.png)
