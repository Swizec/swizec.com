...
![Auth0 dashboard screenshot](https://swizec.com/blog/wp-content/uploads/2019/01/dashboard-screenshot.png)
...
![Callback config](https://swizec.com/blog/wp-content/uploads/2019/01/callback-screenshot-1.png)
...
```undefined
<code>$ gatsby new gatsby-auth0-playground
</code>
```
