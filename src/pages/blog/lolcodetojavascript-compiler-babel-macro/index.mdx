...
_Aside: an [interpreter](https://en.wikipedia.org/wiki/Interpreter_(computing)) executes your code as it&#x27;s read, a [compiler](https://en.wikipedia.org/wiki/Compiler) translates it to a different language (or machine code) to be executed later. Important distinction\_
