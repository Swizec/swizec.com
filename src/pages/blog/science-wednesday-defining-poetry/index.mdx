...
Poetry is simple to define - _a [poem](http://en.wikipedia.org/wiki/Poetry) is a poem because people consider it a poem._

Simple. Easy to understand. Useless.

![Alexander Blok's poem 'Noch, ulica, fonar, apt...'](./img/Alexander-Bloks-poem-Noch-ulica-fonar-apt397jic.jpeg)

When you are [studying poetry](https://swizec.com/blog/science-wednesday-towards-a-computational-model-of-poetry-generation/) in a scientific context, even [creating a poetry generator](https://github.com/Swizec/Le-Thesis) for your graduation thesis, you need a definition that goes beyond intuitive notions of poetry.

Specifically, you need [falsifiable](http://en.wikipedia.org/wiki/Falsifiability) results, a way to decide what piece of text is gibberish and what is poetry. Answering the question "Is this art?" is impossible, so Manurung came up with a better definition of poetry in his doctorate thesis _[An evolutionary algorithm for poetry generation](http://academic.research.microsoft.com/Paper/2348039.aspx)._
...
Usual suspect properties of poetry apply here, exactly the ones you learned about in high school. Things such as rhythm, metre, [phonemic](http://en.wikipedia.org/wiki/Phoneme) patterns and [figurative language](http://en.wikipedia.org/wiki/Literal_and_figurative_language).
...
![Ambiguity in partitioning metre into feet](https://swizec.com/wp-content/uploads/2012/03/metre.png)
...
Any [automatic poetry](http://en.wikipedia.org/wiki/Surrealist_techniques) generator bumps into the problem that _Readers of \[poetry] are prepared to do considerable interpretative work ... In general, the more the audience is prepared to contribute in responding to a work of art, themore chance there is that a computer's performance may be acknowledged as aesthetically valuable (Boden 1990)_
