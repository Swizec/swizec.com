...
In December 1972, David L. Parnas published [_On The Criteria To Be Used In Decomposing Systems Into Modules_](https://www.cs.umd.edu/class/spring2003/cmsc838p/Design/criteria.pdf) and set the stage for the concept of [information hiding](http://en.wikipedia.org/wiki/Information_hiding) in systems design.
...
[Modularization](http://en.wikipedia.org/wiki/Modularity) gives us three main benefits:
...
For example, let's take a simple [KWIC index](http://en.wikipedia.org/wiki/Key_Word_in_Context). You get an ordered set of lines, which contains an ordered set of words, which are ordered sets of characters. Lines can be circularly shifted by taking the first word and placing it at the end.
...
2.  [Circular Shift](http://en.wikipedia.org/wiki/Circular_shift) module - prepares an index of circular shifts
...
[Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=1cd36eb5-c19b-4e2b-9e2a-90c200f1aec0)