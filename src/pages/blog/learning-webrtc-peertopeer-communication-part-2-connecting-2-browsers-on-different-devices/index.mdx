...
hero: ./img/blog-wp-content-uploads-2018-05-signalconnection.png
---
...
![](./img/blog-wp-content-uploads-2018-05-photo_may_16_1_09_35_pm.jpg)
...
![](./img/blog-wp-content-uploads-2018-05-signalconnection.png)
...
Learning our lesson from [WebRTC part 1](https://swizec.com/blog/learning-webrtc-peer-peer-communication-part-1/swizec/8359), we split our RTCPeerConnection stuff into [a helper class](https://github.com/Swizec/webrtc-sample/blob/master/src/PeerConnection.js).



It&#x27;s about 148 lines and handles the whole lifecycle. We [talked about the code before](https://swizec.com/blog/learning-webrtc-peer-peer-communication-part-1/swizec/8359), so here&#x27;s a recap 👇



![](./img/blog-wp-content-uploads-2018-05-peerconnection.png)
