...
![d3 react 16.3](https://swizec.com/blog/wp-content/uploads/2018/04/d3react16.3-699x1024.png)

That's right, you can have complex objects in state now. It's totally safe.

https://twitter.com/ryanflorence/status/984513942696296448?ref_src=twsrc%5Etfw
...
```undefined
<code>class BarChart extends React.Component {
  state = {
    widthScale: d3
      .scaleBand()
