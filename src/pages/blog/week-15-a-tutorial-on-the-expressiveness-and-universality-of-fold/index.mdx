...
Fold as a central concept in a programming language dates from [APL](http://en.wikipedia.org/wiki/APL_%28programming_language%29)'s reduction operator in 1962 and later [FP](http://en.wikipedia.org/wiki/Functional_programming)'s insertion operator in 1978. In [Haskell](http://haskell.org) it's defined like this:

![Fold in Haskell](./img/images-8825.png)
...
There's also a [right fold](http://en.wikipedia.org/wiki/Fold_%28higher-order_function%29), _foldr_, which does the same, but right-to-left. Using foldl vs. foldr changes the associativity of the supplied function:
...
![Length implemented using fold](./img/images-8831.png)

You see, instead of transforming the string, that lambda function just counts.

## The [universal property](http://en.wikipedia.org/wiki/Universal_property) of fold
...
![Universal property](./img/images-8867.png)
...
The universal property is particularly useful as a **proof principle** because it encapsulates a common pattern of [inductive proof](http://en.wikipedia.org/wiki/Mathematical_induction). Rather than mess about with induction, you can just appeal to the universal property.
...
![Proof of sum = fold](./img/images-8945.png)
...
![Conditions for equivalence](./img/images-8948.png)
...
![Recursively defined sum](./img/images-8950.png)
...
![Definition of dropWhile'](./img/images-8958.png)
...
![Primitive recursion](./img/images-8960.png)
...
![Folded recursion](./img/images-8962.png)
...
![Compose as a fold](./img/images-8963.png)
...
![Ackermann's function](./img/images-8964.png)
...
![Enhanced by Zemanta](./img/zemified_e.png)
