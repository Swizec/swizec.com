...
description: "eightthings.pdf is the best paper I've read on what's going on in AI right now and why everyone is excited. It's a literature review paper and very accessible. Here's my summary."
...
few-show and in-context learning are the most exciting surprises. Modern LLMs can learn new tasks _without training_.
...
3. **Reinforcement learning (RHLF)** where you reward the model for good behavior until it learns new tricks, like a puppy
...
They show syncopanthic behavior where they flatter and reinforce your misconceptions. If you push back on GPT, it's likely to fold and say you're right. Not because its answer was wrong, but because it wants you to be happy.
