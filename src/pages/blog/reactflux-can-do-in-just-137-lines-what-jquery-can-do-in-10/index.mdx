    ...
    render: function () {
        return (
            <div class="form-group">
                ...
                <textarea id="body" style={{height:"300px"}}="" class="form-control" placeholder="Paste your email body here. HTML is fine, we'll convert it to a text-only format." value={this.props.value} onchange={this.update}>                <p class="help-block">This will become the prefilled body.</p>
            </div>
        );
    }
});
...
PS: I'm working on a book about testing React code, <a href="mailto:swizec@swizec.com?subject=I%20like%20testing%20React!&body=Hey%20Swizec%2C%20I%20want%20to%20learn%20more%20about%20writing%20tests%20for%20React%20code.%20In%20particular%20I%20want%20to%20know%20more%20about%20______%20Cheers%2C%20~%20My%20Name">send me an email</a>, if you're interested

<strong>Thanks</strong> to Will Fanguy, Tiffany Morgan, David Bairne, and Coletta
Teskey for reading draft copies of this article.