...
![soba fest 095](https://swizec.com/wp-content/uploads/2011/10/6229977151_4f39755c38_m1.jpg)

On Friday I said that [Functional isn't always better](https://swizec.com/blog/functional-isnt-always-better/), but really it was a post about my failings as a functional programmer in finding an elegant solution to the problem of transforming a list of values into a list of pairs.
...
Solutions were posted in [Clojure](http://clojure.org), [Haskell](http://haskell.org), [Python](http://www.python.org/), J, Scala, [Javascript](http://en.wikipedia.org/wiki/JavaScript), [Erlang](http://www.erlang.org), [SmallTalk](http://en.wikipedia.org/wiki/Smalltalk), C#, [Ocaml](http://caml.inria.fr/index.en.html), F#, ... and some language I didn't recognize nor did the poster specify what it was.
