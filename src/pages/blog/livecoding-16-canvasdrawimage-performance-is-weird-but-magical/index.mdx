...
![Canvas drawImage Performance](./img/eSfblPT.gif)
...
![Canvas drawImage Example](./img/902lShK.gif)
...
![Canvas drawImage with Image() object](./img/K3JIWBY.gif)
...
![Time-based physics](./img/tQ1aiHw.gif)
...
![14,000 smoothly animated minions](./img/JW4MSzk.gif)
