...
hero: ./img/screenshot-1667925771156.png
---

[name|Friend] two years ago I wrote [When your brain is breaking, try XState](https://swizec.com/blog/when-your-brain-is-breaking-try-xstate/) after building a UI interaction so twisted my brain leaked out my ears. [XState](https://xstate.js.org), a state machine library, helped.
...
PS: this is what I mean by [focus on fundamentals](https://swizec.com/blog/reader-question-should-you-learn-the-latest-hotness/) [name|]. XState and Stately are tools that come and go, but [state machines have been with us since 1956](https://en.wikipedia.org/wiki/Moore_machine).
