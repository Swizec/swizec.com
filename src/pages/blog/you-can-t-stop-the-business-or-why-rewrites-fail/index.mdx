...
_PS: you can [read and share this online](https://swizec.com/blog/you-can-t-stop-the-business-or-why-rewrites-fail/)_
...
Naturally, the system was even worse than we feared. <https://swizec.com/blog/the-italian-foods-theory-of-bad-software-design/[Spaghetti> code] barely begins to describe it. Control flow bounced from function to function, module to module, with zero rhyme or reason. A masterpiece produced by years of _"Oh I'll just add this quick special case right here"_.
