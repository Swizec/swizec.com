...
categories: "Code refactoring, Kent Beck, Languages, Martin Fowler, Methodologies, Programmer, Programming, Refactoring, Uncategorized"
...
![Refactoring](./img/_aYqOeKEM97s-TPZnWcXbwPI-AAAAAAAAAFk-kXux_iDWy8w-s1600-codeRefactoring.gif "Refactoring")

Nikos Maravitsas writes about _[What refactoring is and what it isn't](http://www.javacodegeeks.com/2012/04/what-refactoring-is-and-what-it-isnt.html)_ over at Java Code Geeks.
...
>
> ![We need this to understand how you use our service - you can take it out if you like. Cheers, your Blogspire team.](https://blogspire.zemanta.com/pixie/ehz1WpCMTBqDdYS5VMr9hQ.57859/blog.gif)

_But that other guy before me was stupid! He did it wrong! All wrong! Wah wah wah ..._

Definitely something I've been guilty of throughout my coding career. Even went so far as justifying it in a blogpost where I asked \_[Are you a boyscout coder?](https://swizec.com/blog/are-you-a-boy-scout-coder) \_The gist of my question was whether clients should be charged for refactoring work or not.
...
> [Refactoring](http://en.wikipedia.org/wiki/Code_refactoring "Code refactoring"), as originally defined by [Martin Fowler](http://martinfowler.com/ "Martin Fowler") and [Kent Beck](http://en.wikipedia.org/wiki/Kent_Beck "Kent Beck"), is
>
> _A change made to the internal structure of software to make it easier to understand and cheaper to modify without changing its observable behavior… It is a disciplined way to clean up code that minimizes the chances of introducing bugs._
>
> /.../
>
...
Nikos goes on to explain _how_ to refactor:
...
Call redesigning and/or rewriting what it is - _redesigning_. If there's a business case for it, go ahead, if it makes sense to redesign now before things get messy, go ahead. For the sake of yourself and everyone around you, just don't do these things in the name of _Refactoring._
...
[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=e998cd27-7776-4320-92af-ec753e607615)](http://www.zemanta.com/ "Enhanced by Zemanta")
