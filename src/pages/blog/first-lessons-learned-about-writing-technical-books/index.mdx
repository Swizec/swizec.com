...
A while ago a [publisher](http://en.wikipedia.org/wiki/Publishing) contacted me to write a book on d3.js.
...
[![d3.js](https://swizec.com/wp-content/uploads/2013/01/d3.js.png)](https://swizec.com/wp-content/uploads/2013/01/d3.js.png)
...
I'm learning a lot writing this book, suddenly d3 is no longer a mystery only [mbostock](https://twitter.com/mbostock) and [New York Times](http://www.newyorktimes.com) know how to use ... I'd go so far as saying the book will be better because I'm writing it _as I learn_ because I still remember which parts need more attention.

This being my first technical book _and_ my first book with a real publisher and [ISBN number](http://en.wikipedia.org/wiki/International_Standard_Book_Number), I'm learning more than just d3.js.
...
## 3. This is not [creative writing](http://en.wikipedia.org/wiki/Creative_writing). By far.
