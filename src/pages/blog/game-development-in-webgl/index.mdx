...
[Game screen](https://swizec.com/wp-content/uploads/2012/11/Screen-Shot-2012-11-19-at-8.55.30-PM.png)
...
[Sprites](https://swizec.com/wp-content/uploads/2012/11/text.png)

Printing text in [OpenGL](http://www.opengl.org/) is not as easy as one would think. It’s usually done by creating a [texture atlas](http://en.wikipedia.org/wiki/Texture_atlas) with all the characters that you intend to use. When you have your atlas texture loaded, you need to calculate the correct [uv coordinates](http://en.wikipedia.org/wiki/UV_mapping) for each character or sprite in the atlas. I’ve created a helper function that calculates the uv coordinates, I only need to specify the sprite offset and the size:
