...
![conspiracy_theory_board](./img/media-l0IylOPCNkiqOgMyA-giphy.gif)
...
![3-state state machine visualized with XState](./img/cHQdm62.png)

[You can see the full state machine in the XState visualizer by clicking here.](https://xstate.js.org/viz/?gist=7d8dc2133f897c61857d5509fb780658)
