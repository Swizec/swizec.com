...
![Sun at Rimski Zid](./img/tumblr_lja8awZaYe1qekjngo1_500.jpg)The comparison I chose to go for is hard computation - namely calculating a list of primes up to a certain number. Why this test? Because primes are awesome!
...
![The raw data](./img/BkTG0.png)

![First graph](./img/22s7m.png)

![Second graph](./img/qXPSS.png)
