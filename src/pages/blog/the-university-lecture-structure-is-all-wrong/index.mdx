...
categories: "Artificial intelligence, food for thought, Lisp, Uncategorized"
hero: ../../../defaultHero.jpg
---

- [A mathematics lecture, apparently about linear...](https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Math_lecture_at_TKK.JPG/300px-Math_lecture_at_TKK.JPG)

  Image via [Wikipedia](http://commons.wikipedia.org/wiki/Image:Math_lecture_at_TKK.JPG)

Yesterday I was attending a lecture about [artificial intelligence](http://en.wikipedia.org/wiki/Artificial_intelligence) and [Lisp](http://en.wikipedia.org/wiki/Lisp_%28programming_language%29).

The whole thing was a complete brainfuck, most of the time I was left with eyes glazed over staring at the projection and feeling a little bit butt raped. And yet, I still feel like I've learned a lot and the whole thing was a very worthwhile way of spending time. This is very often the case with outside [university](http://en.wikipedia.org/wiki/University) lectures, brainfuck to the extreme, yet useful.

On the other hand we have university lectures. They are only very rarely a complete brainfuck and when they _are_ a brain fucking machine, they're so high in the [stratosphere](http://en.wikipedia.org/wiki/Stratosphere) you can't even begin to hope to start comprehending what the fuck is going on. These are also the kind of lectures you'd be hard pressed to listen to for more than 45 minutes at a time and are all together almost quite useless.
...
[Reblog this post [with Zemanta]](https://img.zemanta.com/reblog_e.png?x-id=44c0d493-504f-45cf-9559-6f7ce28806a2)