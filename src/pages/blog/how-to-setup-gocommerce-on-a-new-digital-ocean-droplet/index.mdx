...
[![](https://swizec.com/blog/wp-content/uploads/2018/01/Screen-Shot-on-2018-01-23-at-141356-1024x577.png)](https://www.youtube.com/embed/O0P7YIiQm4Y?start=11147)
...
```undefined
<code>$ sudo add-apt-repository ppa:gophers/archive
$ sudo apt-get update
...
```undefined
<code>$ mkdir ~/go/src/github.com/netlify
</code>
```
...
```undefined
<code>$ cd ~/go/src/github.com/netlify
$ make deps
$ make build_linux
</code>
```
...
```undefined
<code>GOCOMMERCE_SITE_URL=http://jamcommerce.netlify.com
...
```undefined
<code>$ systemctl start gocommerce
</code>
```
