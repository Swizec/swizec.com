...
![Random GIF](./img/media-RHJxHbbaeIOyNf8jf7-giphy.gif)
...
![Random GIF](./img/media-SDogLD4FOZMM8-giphy.gif)
...
`<p>` is styled with a green background, rounded corners, and a bit of padding.

![Tooltip example](https://swizec.com/wp-content/uploads/2018/12/tooltip-closeup-1.png)
...
All that is followed by our mouse eve handling functions.
...
Render a grouping element that centers our donut on `(x, y)` coordinates, render `<Arc>`s in a loop.
...
![Dataviz example](https://swizec.com/wp-content/uploads/2018/12/christmas-stockings-1-1024x750.png)
