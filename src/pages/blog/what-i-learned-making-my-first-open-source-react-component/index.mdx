...
---
Dude, open source is hard. People really do this every day!? 🤨I open sourced my [react-lazyload-fadein](https://github.com/Swizec/react-lazyload-fadein) component this weekend. 75 stars already. I guess people like it 💪
...
[Building the component](https://swizec.com/blog/fade-in-lazy-loaded-images-react-css-quick-guide/swizec/8163) was pretty quick. Learn the new API for React transitions, realize images have an `onLoad` event, package it up in a component. Easy 👌
...
```undefined
<code>nwb new react-component react-bla
</code>
```
...
```undefined
<code><FadeIn>{onload => <MyThing onLoad={onload} />}</FadeIn>
</code>
```
...
```undefined
<code><FadeIn render={onload => <MyThing onLoad={onload} />} />
</code>
```
...
![](./img/blog-wp-content-uploads-2018-02-shia-labeouf-do-it-1.gif)
