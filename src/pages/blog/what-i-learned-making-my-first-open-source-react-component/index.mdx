...
[Building thecomponent](https://swizec.com/blog/fade-in-lazy-loaded-images-react-css-quick-guide/swizec/8163) was pretty quick. Learn the new API for React transitions, realize images have an `onLoad` event, package it up in a component. Easy 👌
