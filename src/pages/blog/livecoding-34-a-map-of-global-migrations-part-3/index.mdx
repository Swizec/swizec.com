...
\[caption id="attachment_7454" align="alignnone" width="1291"][![Click on the map to see a live example](./img/blog-wp-content-uploads-2017-02-uk-migrations.gif)](https://swizec.github.io/migrations-map/) Click on the map to see a live example\[/caption]
...
![](./img/blog-wp-content-uploads-2017-02-bursty-map-1.gif)
...
![](./img/blog-wp-content-uploads-2017-02-drag-1.gif)
