...
![server-side d3](https://swizec.com/wp-content/uploads/2017/09/server-side-d3.gif)
...
![server-side d3 no flash](https://swizec.com/wp-content/uploads/2017/09/server-side-d3-no-flash.gif)
...
![statuejpgaa03i3](./img/statuejpgaa03i3.jpeg)
