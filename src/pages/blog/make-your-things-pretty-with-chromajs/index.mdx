...
![Piechart Colored with Chroma-js](https://swizec.com/wp-content/uploads/2018/03/piechart-colored-with-chromajs.png)
...
See the Pen [Chroma basic scale](https://codepen.io/swizec/pen/XZGvYe/) by Swizec Teller ([@swizec](https://codepen.io/swizec)) on [CodePen](https://codepen.io).
...
![Lch vs RGB](https://swizec.com/wp-content/uploads/2018/03/lch-vs-rgb.png)

You can create continuous scales as well. Add multiple points of reference etc. Great for encoding data with color.

![Continuous Scales](https://swizec.com/wp-content/uploads/2018/03/continuous-scales.png)

## Prettier hover effects

![Hover Effect](https://swizec.com/wp-content/uploads/2018/03/hover-effect.gif)
