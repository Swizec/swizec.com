...
A few days ago I implemented my first full [neural network](http://en.wikipedia.org/wiki/Neural_network) in Octave. Nothing too major, just a three layer network recognising hand-written letters. Even though I [finally understood what a neural network is](https://swizec.com/blog/i-think-i-finally-understand-what-a-neural-network-is/), this was still a cool challenge.
...
![Neural network cost function](https://swizec.com/wp-content/uploads/2011/11/Screen-Shot-2011-11-16-at-1.07.26-AM.png)

![Neural network backpropagation](https://swizec.com/wp-content/uploads/2011/11/Screen-Shot-2011-11-16-at-1.08.17-AM.png)
