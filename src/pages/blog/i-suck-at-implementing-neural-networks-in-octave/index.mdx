...
A few days ago I implemented my first full [neural network](http://en.wikipedia.org/wiki/Neural_network "Neural network") in Octave. Nothing too major, just a three layer network recognising hand-written letters. Even though I [finally understood what a neural network is](https://swizec.com/blog/i-think-i-finally-understand-what-a-neural-network-is/swizec/2891 "I think I finally understand what a neural network is"), this was still a cool challenge.
...
[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=2cd7a0e7-5dea-4e23-8cd7-086d494a8ef1)](http://www.zemanta.com/ "Enhanced by Zemanta")
