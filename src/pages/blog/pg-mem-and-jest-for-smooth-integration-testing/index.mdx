...
categories: "Backend, JavaScript, TypeScript, Testing, Jest"
hero: ./img/screenshot-1640148145574.png
---

It's no secret that I think [the cult of TDD](https://swizec.com/blog/25-lessons-from-25-years-of-coding/#2-tests-are-great-but-tdd-is-a-cult) leads you down a dark and stormy path towards brittle code with a false sense of security.
