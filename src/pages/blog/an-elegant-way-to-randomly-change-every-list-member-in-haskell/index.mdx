...
Randomness is a bit of a strange concept in [Haskell](http://haskell.org).
...
Cleaner, less work, more obvious what's going on. And it just happens to be perfect for writing [evolutionary algorithms](http://en.wikipedia.org/wiki/Evolutionary_algorithm) in Haskell. But more on that later, hopefully as early as Friday.
