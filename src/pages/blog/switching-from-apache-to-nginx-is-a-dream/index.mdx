...
categories: "Apache, intrigues, life, Server, Uncategorized, WWW"
...
Since as far back as my memory goes I've been using [Apache](http://en.wikipedia.org/wiki/Apache_HTTP_Server) for my main, primary, and absolutely only [webserver](http://en.wikipedia.org/wiki/Web_server). It was the workhorse of everything from dev environments to production machines serving tens of pages.

But throughout this love affair there was one constant - I had to change things.

This isn't bad. Of course when you first start using [mod_rewrite](http://en.wikipedia.org/wiki/Rewrite_engine) you're going to have to change things and naturally adding a new website on a new domain means changing a few things. No problem here, all natural.
...
So there you go @[robertbasic](http://twitter.com/robertbasic), @genom, @loudandwicked, @jaspertandy ... a blog post about the change.

PS: about versatility and such that @genom mentioned, I haven't a bloody clue (yet)

PS2: apologies to everyone I mentioned in the post and didn't link to, Zemanta didn't suggest the links and I'm too lazy to do them manually.
