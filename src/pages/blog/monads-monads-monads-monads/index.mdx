...
[Monad tutorials growth](./img/wikiupload-2-23-Monad-tutorials-chart.png)

This isn't a [monad](http://en.wikipedia.org/wiki/Monad_%28functional_programming%29) tutorial.

It _could_ be a monad tutorial, but I still don't understand monads. I don't think I ever will.

Monads were invented to fuck with us developers of lesser minds, the ones who don't want to bend over backwards to maintain [functional purity](http://en.wikipedia.org/wiki/Purely_functional) and would perhaps rather ... you know ... get things done instead. Really, sometimes I just want things to _work_. I don't even care how.
...
I spent the entire day in **_Monad Hell _**getting it done in [Haskell](http://haskell.org). And that's after the [dependency hell](http://en.wikipedia.org/wiki/Dependency_hell) of installing _Chart_ on my computer ... _cabal_ isn't very good, but that's a whole different blogpost.
...
I don't know what instances are, not completely, but they look like a magic thing that can make [type conversions](http://en.wikipedia.org/wiki/Type_conversion) automatic. And that's awesome so I need to look it up.
...
[Money graph](https://swizec.com/wp-content/uploads/2012/09/graph1.png)
