...
![Bar Chart code](https://swizec.com/wp-content/uploads/2018/02/barchartcode.png)

There are two parts to this code: Data manipulation and DOM manipulation.

[![Bar chart data manipulation code](https://swizec.com/wp-content/uploads/2018/02/barchartcode-data.png)](Bar chart data manipulation code)
...
![Function color example](./img/wikipedia-commons-thumb-d-df-Function_color_example_3.svg-440px-Function_color_example_3.svg.png)
