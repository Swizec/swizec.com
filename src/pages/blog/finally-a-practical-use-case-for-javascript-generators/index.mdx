...
description: "JavaScript generators are amazing. They let you write infinite loops that terminate. Yield values from functions before they finish. Build lazy data structures. Lazy evaluation programming! And I bet you've never used a JavaScript generator even once did you? Do you even know the syntax? Turns out generators aren't very useful in practice. 😢 But yesterday, after years of knowing about generators, years of itching to use them, years of ... I FOUND A USE! A real world practical use-case where generators actually make your code better. 😱"
