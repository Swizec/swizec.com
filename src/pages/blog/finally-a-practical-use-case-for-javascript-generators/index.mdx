...
---
JavaScript generators are amazing. A brilliant concept infinitely useful on paper.They let you write infinite loops that terminate. Yield values from functions before they finish. Build lazy data structures. Lazy evaluation programming!A functional programmer&#x27;s wet dream. 😍And I bet you&#x27;ve never used a JavaScript generator even once did you? Do you even know the syntax?I bet you don&#x27;t.Turns out generators aren&#x27;t very useful in practice. 😢But yesterday, after years of knowing about generators, years of itching to use them, years of ... I FOUND A USE! A real world practical use-case where generators _actually_ make your code better. 😱
...
```undefined
<code class="javascript">const UserRegex = new RegExp(/@(\w+)/, "g");
</code>
```
...
```undefined
<code class="javascript">function* getUsernames(string) {
    let match = null;
...
```undefined
<code class="javascript">const string = "this is a test with @swizec and @kyleshevlin, maybe @lukeed05"
