...
[A smol EnvironmentHelper class](./img/techletter.app-screenshot-1586877415543.png)
...
[EnvironmentHelper with default values](./img/techletter.app-screenshot-1586877415495.png)
...
![EnvironmentHelper that preserves state](./img/techletter.app-screenshot-1586877415484.png)
...
![Tests based on truth table](./img/techletter.app-screenshot-1586877415427.png)
...
![Found the bug](./img/techletter.app-screenshot-1586877415481.png)

That means we overwrite the cookie with an empty value when there's no URL param. Should look like this:

![Fixed the bug](./img/techletter.app-screenshot-1586877415231.png)
