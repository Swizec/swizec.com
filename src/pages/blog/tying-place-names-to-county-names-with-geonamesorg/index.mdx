...
Borough, county, parish, census area, municipality and sometimes city (but sometimes not) all mean the same – a county. Oh, and [names are not globally unique](https://swizec.com/blog/livecoding-24-choropleth-react-js/swizec/7078), only state-unique. Marvelous.
