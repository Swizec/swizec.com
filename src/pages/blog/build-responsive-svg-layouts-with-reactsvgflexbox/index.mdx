...
```javascript
 <Flexbox style={{ flexDirection: "row", justifyContent: "flex-start", flexWrap: "wrap", width: 1024, height: 1024}}>
</Flexbox>
```
...
class App extends Component {
    ...
    render() {
        ...
        <svg style={{ width: "100%", height: "100%"}} ref={this.svgRef}>
            <Flexbox style={{ flexDirection: "row", justifyContent: "flex-start", flexWrap: "wrap", width: this.state.width, height: 1024}}>
    }
</Flexbox></svg>
```
