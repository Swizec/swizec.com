...
[name|Friend], the extra space is no more! All fixed. Here's a little backstory that I hope inspires you to build more tools for yourself.

https://twitter.com/Swizec/status/1637584633671061504
![](./img/R4Tg3Jpngf228af.png)
...
_PS: you can [read and share this on the web](https://swizec.com/blog/are-you-annoyed-by-the-extra-space-after-your-name-name/)_
...
Yes [name|] many readers complained about the extra space since I added the feature in August 2020. About one per quarter. It never quite made the priority list 😇
...
[sparkjoy|are-you-annoyed-by-the-extra-space-after-your-name-name]
