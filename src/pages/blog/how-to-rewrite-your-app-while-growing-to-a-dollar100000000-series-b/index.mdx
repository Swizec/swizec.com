...
![Tia Series B announcement](./img/Tia-Series-B-announced-on-the-famous-Nasdaq-screendeaj78.jpeg)
...
As [Software Engineering at Google](https://swizec.com/blog/what-i-learned-from-software-engineering-at-google/) says, you can't scale 5x when every new engineer creates extra work for others. And when every spaghetti in your bowl of code pulls on another spaghetti, guess what happens.

![Scalable-unscalable divide](./img/The-scalable-unscalable-divide7a6eg4.png)
