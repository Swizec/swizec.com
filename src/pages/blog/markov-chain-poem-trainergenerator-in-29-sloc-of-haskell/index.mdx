...
To make everything a bit smoother, I've written a [Markov chain](http://en.wikipedia.org/wiki/Markov_chain) generator in [Haskell](http://haskell.org) that generates the initial population. The principle is very simple:
