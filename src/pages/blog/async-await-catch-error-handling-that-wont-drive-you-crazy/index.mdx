...
![image](./img/media-DyvM7QQUUAAiUvA.png)
...
![image](./img/media-DyvNQaxUwAILdut.png)
...
![image](./img/media-DyvNXUrUUAELUz2.png)
...
![image](./img/c552b61f64ea71b300d847d9d5e8fb19-tumblr_inline_orekae8QzG1sz9gyq_540.gif)

Oh I know! We can move using data to after the catch block, right? That should work.

![image](./img/media-DyvN3fQU0AAfjCq.png)

Nope. Now `data` isn't defined because `{ data }` only works within that try block. 🤦‍♂️
...
![image](./img/media-DyvOHz8VYAEpl6r.png)
...
![image](./img/media-9Y5BbDSkSTiY8-giphy.gif)
