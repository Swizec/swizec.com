...
![2 fetches, 1 callback](https://swizec.com/wp-content/uploads/2016/08/chrome-eats-objects.gif "2 fetches, 1 callback")
...
I used `create-react-app` to setup a basic environment, ejected with `npm run eject` and added some config to Webpack to allow jQuery. Backbone depends on it. This part is not _that_ relevant.
...
![Works in Safari](https://swizec.com/wp-content/uploads/2016/08/safari-does-not.gif "Works in Safari")

![Works in Firefox](https://swizec.com/wp-content/uploads/2016/08/firefox-works-too.gif "Works in Firefox")
