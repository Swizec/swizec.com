...
I've been listening to the ["DOM is slow"](https://www.google.com/search?q=dom+is+slow&oq=dom+is+slow&aqs=chrome..69i57j0l5.1249j0j1&sourceid=chrome&ie=UTF-8) mantra my whole life. But with that feature, I discovered that the DOM is pretty fast, actually.
...
![React DOM](https://swizec.com/wp-content/uploads/2018/02/react-dom.gif)
...
![Naive JS DOM](https://swizec.com/wp-content/uploads/2018/02/naive-js-dom.gif)
...
![Smart JS DOM](https://swizec.com/wp-content/uploads/2018/02/smart-js-dom.gif)
...
![Final Image](./img/media-l2JehIXdp8F7Up5sc-giphy.gif)