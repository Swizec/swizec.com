...
<https://www.youtube.com/watch?v=3abrq1N5ITU[Advent> of Code](<https://adventofcode.com/>) is an advent calendar for coders. A daily puzzle that exercises that algorithmic part of coding that you don't usually get to use in day to day programming.
...
```undefined
<code>A scanner with range 1, is at 0 every 1 picosecond.
