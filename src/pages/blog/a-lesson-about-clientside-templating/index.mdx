...
A few months ago I gave a talk entitled _[Tools that get you laid](https://swizec.com/blog/webcamplj-was-bitchin/swizec/2696 "#WebcampLj was bitchin’")_ at [WebCamp Ljubljana](http://webcamp.si/). The basic premise was that client-side MVC is so insanely awesome you are sure to get laid for using it. The main benefits I talked about were:
