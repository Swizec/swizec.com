...
But as browser apps become ever more powerful it only makes sense to realize callback soup isn't fun and _hey, wasn't there some paradigm we use on [servers](https://en.wikipedia.org/wiki/Server_(computing)) to make this web insanity work? Yeah, there is.
