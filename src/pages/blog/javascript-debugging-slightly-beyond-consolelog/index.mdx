...
[Pascal](http://en.wikipedia.org/wiki/Pascal_%28programming_language%29) acting up? Not sure what's going on? `writeln`

[Python](http://www.python.org/) being silly? `print`

C acting funny? `printf`

[CSS](http://en.wikipedia.org/wiki/Cascading_Style_Sheets) weird? `border: 1px solid red`

[HTML](http://en.wikipedia.org/wiki/HTML) messing with you? Nah, [Chrome](http://www.google.com/chrome)'s element inspector.
...
![The debugger, initial view](./img/images-25868.png)

You can't see it in the screenshot, but even [GIFs](http://en.wikipedia.org/wiki/Graphics_Interchange_Format) are stopped. A moment ago that Santa was dancing, now everything is in _"Holy shit, he's debugging!"_ mode.
...
![Console is in current scope](./img/images-25870.png)
