...
On Monday I released these buttons and as many of you noted I seriously didn't do nearly enough testing and what's worse, I even bragged about the fact. But some of you perhaps noticed my edits to the blogpost where I said I'd make it all better. Well, here's Wednesday and I made it all better while still, as promised, spending much less time than Google probably did. Think I've spent under 20 hours for the whole thing from inception to finish (now). If you're lazy just head over to the [jQuery imageless buttons a la Google examples/documentation](https://swizec.com/code/styledButton) page.

Let's start off with a screenshot of what the buttons look like on modern browsers

![Imageless buttons on proper browsers](https://swizec.com/code/styledButton/normal_example.png "Imageless buttons on proper browsers")
...
![Imageless buttons in Firefox 2](https://swizec.com/code/styledButton/FF2_example.png "Imageless buttons in Firefox 2")

And what they're like Internet Explorer 6

![Imageless buttons in IE6](https://swizec.com/code/styledButton/ie6_example.png "Imageless buttons in IE6")
...
Since you're still reading, please head over to the [jQuery imageless buttons a la Google](https://swizec.com/code/styledButton) examples now.
