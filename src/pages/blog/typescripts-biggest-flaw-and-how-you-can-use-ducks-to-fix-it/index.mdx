...
You're duck typing every time you write code like `{object.property && object.property.value === 'something'}`
...
[Click through for source](<https://carbon.now.sh/?bg=rgba(255,255,255,1)&t=seti&l=typescript&ds=true&wc=true&wa=true&pv=48px&ph=32px&ln=false&code=function%20isDuck(animal%3A%20Duck%20%7C%20Elephant%20%7C%20Donkey)%20%7B%0A%09return%20%22swim%22%20in%20animal%20%26%26%20%22fly%22%20in%20animal%3B%0A%7D>)
