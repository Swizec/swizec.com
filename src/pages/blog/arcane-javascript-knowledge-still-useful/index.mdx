...
![](https://swizec.com/blog/wp-content/uploads/2017/11/yuploader.gif)
...
```undefined
<code>Uncaught TypeError: Cannot read property 'call' of undefined
...
```undefined
<code>// Execute the module function
...
![](https://swizec.com/blog/wp-content/uploads/2017/11/tired-at-computer.gif)
...
We use [Webpack to split our app into multiple files](https://swizec.com/blog/dirty-hack-took-30percent-off-webpack-size/swizec/7657). Libraries go into an `app_vendor.js` file, and our code goes into an `app.js` file. Most of our apps also have chunks that Webpack loads asynchronously when they're needed.
...
![](https://swizec.com/blog/wp-content/uploads/2017/11/cosby-facepalm.gif)
