...
For the past few weeks I've been giving [Klok](http://klok.mcgraphix.com/klok/index.htm) a spin. Last time I've [mentioned Klok](https://swizec.com/blog/five-reasons-a-developer-should-avoid-adobe-air/2/397) it was just after a quick install and neglect, but I did always intend on giving it a try. Then when its creator [Rob McKeown](http://agileui.blogspot.com/) commented on the post I knew there was no escaping giving Klok a try. So I started using it full-time to track my time, however odd that comes out when one says it.
