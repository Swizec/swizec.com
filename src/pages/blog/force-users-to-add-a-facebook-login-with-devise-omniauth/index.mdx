...
But that only solves the problem of forcing [Facebook](http://en.wikipedia.org/wiki/Facebook) on authorization. Who's going to check the conditions on every page load and sign the user out?
...
[Swizec's tweet](https://twitter.com/Swizec/statuses/347024137086173185)

## Force FB with just 19 sloc

There's a better way!

I stumbled on this solution almost by accident after ending up on an obscure API doc page on my gazillionth google search. Turns out you can force a user to sign up with facebook in just under 19 [lines of code](http://en.wikipedia.org/wiki/Source_lines_of_code).
...
[Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=98e2b5a1-87ba-4afc-b043-b54b490c314d)