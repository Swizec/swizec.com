...
[Lazy, by CurlysGirly](./img/6182-6115496574_35ca6b4cf8_z.jpg)
...
Cool, we've implemented python's native _range_ function. Handy, but nothing special.

The power of generators lies in using something more than _+1_ as the core function. How about implementing a naive algorithm for listing prime numbers?
...
As noted in _Improving your code with modern idioms_ a lot of cool tricks like that have been backported from python 3 and you should start using them.
