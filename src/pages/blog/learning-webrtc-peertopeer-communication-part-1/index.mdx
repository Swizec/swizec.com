...
Remember [blockchain-redux](https://github.com/Swizec/blockchain-redux)? Yeah, I'm still working on it. Last time, we got it to [share blocks between clients in real-time](https://swizec.com/blog/blockchain-redux-shares-blocks-between-clients-real-time/swizec/8320).
