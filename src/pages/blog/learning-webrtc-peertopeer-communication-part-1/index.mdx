...
![RTCPeerConnection process sketch](https://swizec.com/wp-content/uploads/2018/05/RTCPeerConnection-process-sketch.png "RTCPeerConnection process sketch")
...
<strong>This is a Livecoding Recap – an almost-weekly post about interesting things discovered while livecoding. Usually shorter than 500 words. Often with pictures. Livecoding happens almost **every Sunday at 2pm PDT** on multiple channels. You should subscribe to [My Youtube](https://www.youtube.com/TheSwizec) channel to catch me live. </strong>