...
![A BDSM-style collar that buckles in the back.](https://swizec.com/wp-content/uploads/2011/10/300px-BDSM_collar_back3.jpg)

For a long time now I've been completely in love with [functional programming](http://en.wikipedia.org/wiki/Functional_programming) to the point that I write functional-style code even in run of the mill normal languages.
