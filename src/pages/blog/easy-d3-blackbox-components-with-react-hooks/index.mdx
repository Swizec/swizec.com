...
![Animated line example](https://swizec.com/wp-content/uploads/2018/11/animated-line.gif)
...
17 sloc function that returns a class-based component with an `anchor`, two lifecycle methods, and a rendered `g` element. That's our anchor.
...
```javascript
<D3blackbox x={0} y={400} render={svg => {
  // D3 code goes here
}} />
```
