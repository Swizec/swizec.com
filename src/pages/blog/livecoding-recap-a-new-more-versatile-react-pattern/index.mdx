...
hero: ./img/blog-wp-content-uploads-2018-03-demo-screenshot.png
---
...
This approach doesn't give you all the benefits of React, and it doesn't scale very well. It's meant for simple components, quick hack jobs, or when you have a lot of existing D3 code you want to use. It is the easiest and quickest way to [translate any random D3 example to React](https://swizec.com/blog/translate-random-d3-example-react/swizec/7765).

Turning that into a library was pretty easy 👇

```undefined
<code>$ nwb new react-component simple-react-d3
<copy pasta>
</code>
```
...
![](./img/blog-wp-content-uploads-2018-03-demo-screenshot.png)
...
![](./img/blog-wp-content-uploads-2018-03-svgblackbox-example.gif)
...
\[caption id="attachment_8299" align="alignnone" width="1328"]![SVGBlackbox](./img/blog-wp-content-uploads-2018-03-finished-svgblackbox.png) SVGBlackbox\[/caption]
