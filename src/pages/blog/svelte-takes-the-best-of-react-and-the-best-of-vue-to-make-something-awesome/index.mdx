...
[![](https://svelte.dev/svelte-logo-horizontal.svg)](https://svelte.dev/)
...
```undefined
<code class="javascript">// src/Movie.svelte
...
```undefined
<code class="javascript">// <Movie> as React
...
```undefined
<code class="javascript">  // this is automatically reactive
  let index = 0;
...
```undefined
<code class="javascript">{#if user.loggedIn}
