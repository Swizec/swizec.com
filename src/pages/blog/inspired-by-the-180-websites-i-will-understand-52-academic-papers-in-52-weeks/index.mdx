...
This got me thinking, what is that one thing I have always wanted to do, but haven't had the right motivation? I already [write](https://swizec.com/blog/a-year-of-750wordscom-with-shiny-graphs/) and [exercise](https://swizec.com/blog/30-day-fitness-experiment-with-results/) every day so that's that for the obvious challenges.
