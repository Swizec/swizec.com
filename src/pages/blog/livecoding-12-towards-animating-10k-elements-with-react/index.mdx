...
So I took my old [particle generator experiment](https://swizec.com/blog/animating-with-react-redux-and-d3/swizec/6775) and started playing around. It doesn’t use a lot of d3, but it does rely heavily on React and Redux.
