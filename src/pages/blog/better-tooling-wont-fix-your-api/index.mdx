...
Until 2 years later a blogger says "{_Hey I want to buy ads_}" and an advertiser says "{_Hey content marketing is cool, can we use your blogging tools?_}"
...
![A white-brown bear](./img/A-white-brown-bear2igh9i.png "A white-brown bear")
...
You give it a bunch of data and say "{_Find 3 classes_}". The algorithm groups every datapoint into 1 of 3 classes based on which mean value they resemble most. Yay.
...
"{_Get me a staff and all their appointments_}"
