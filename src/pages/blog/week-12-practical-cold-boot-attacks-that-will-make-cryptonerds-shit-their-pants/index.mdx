...
categories: "52papers52weeks, Cold boot attack, DRAM, Dynamic random-access memory, Encryption, Laptop, Learning, Personal, Reboot (computing)"
...
![Decaying image at 5s, 30s, 60s, 5min](./img/Decaying-image-at-5s-30s-60s-5mine6c206.png "Decaying image at 5s, 30s, 60s, 5min")
