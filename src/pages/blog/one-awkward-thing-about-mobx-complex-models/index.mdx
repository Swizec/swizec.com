...
![Example Image](https://swizec.com/wp-content/uploads/2016/12/Screen-Shot-2016-12-02-at-07.59.53.png)
...
![Example Image](https://swizec.com/wp-content/uploads/2016/12/Screen-Shot-2016-12-02-at-08.21.44.png)
...
![Example Image](./img/media-IeLOBZb7ZdQ1G-giphy.gif)
...
Assume we put an instance of `MainStore` in a `{MobxProvider}` as `mainStore`. That gives us global access via `inject` and cleans up our codebase.

A simplified `{Subject}` component would look like this:
