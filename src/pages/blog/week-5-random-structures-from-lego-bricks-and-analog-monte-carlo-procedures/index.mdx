...
categories: "52papers52weeks, Althöfer, Brick, Learning, Lego, Lego Bricks, Monte Carlo, Personal, Washing machine, Papers"
...
![Results from a washing run at a party](./img/images-4074.png)
...
![Complexes people think will be generated](./img/Complexes-people-think-will-be-generatedih57c6.png)
...
As silly as these games might seem, others before have played with [LEGOs](http://www.lego.com/) to get interesting results.

A similar set of experiments was done using [Duplo](http://duplo.lego.com/) bricks in January 2013, called Duplo DNA. Another experiment used evolutionary experiments to tackle the "LEGO layout problem": Given a 3D shape, how can it be built out of LEGO bricks?
...
![Stable complexes](./img/Stable-complexes32a3jd.png)
...
Furthermore, this is the most fun and obvious way of showing someone that [random processes](http://en.wikipedia.org/wiki/Stochastic_process) _can_ have predictable results. And that you _can_ throw randomness at a problem until a result falls out.

[Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=579463e7-5669-4c3a-b545-0752a65f11db)
