...
This is a continuation from the last time [I benchmarked node vs. clojure for hard computation](https://swizec.com/blog/comparing-clojure-and-nodejs-for-speed/ "Comparing clojure and node.js for speed"), sort of. This time 'round I decided to benchmark how many concurrent requests a single process of technology X can handle. Threading is fine.
