...
Some weeks ago I've spoken about [clean code and speed coding](https://swizec.com/blog/clean-code-and-speed-coding/), that tried to allude to the fact of how writing code that is clean helps you write code quicker and better. Everything focused around Twitulater and how well its development was going, but today I'd like to give mention of another very important reason development is going so well. [Adobe AIR](http://en.wikipedia.org/wiki/Adobe_Air).
