...
hero: ./img/screenshot-1681224769922
---

[name|Friend], my favorite manager called this "_the most_ important concept for a software engineer to grasp". How do you choose between DRY – do not repeat yourself – and Separation of Concerns?
...
Two tables, different names, same columns, both with a many-to-many relation to appointment types. Should you DRY them up [name|]?
