...
Have you ever wondered what it takes tell which event [happened before](http://en.wikipedia.org/wiki/Happened-before) which in a distributed system?
...
![Distributed system](./img/images-4760.png)
...
![Diagram with time](./img/images-4761.png)
...
To elegantly solve the problem Lamport introduces logical clocks, now known as [Lamport timestamps](http://en.wikipedia.org/wiki/Lamport_timestamps). Simple counters that assign numbers to events.
...
![A more organised diagram](./img/images-4773.png)
...
[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=797ec3ec-ebad-4c86-8c4f-0ed17595b04b)](http://www.zemanta.com/?px)
