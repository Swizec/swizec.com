...
```undefined
<code>ERROR in tutor_onboarding.js from UglifyJs
SyntaxError: Unexpected token: name (defaultHeaders) [./~/better-fetch/index.js:2,0]
</code>
```

![](https://swizec.com/blog/wp-content/uploads/2016/12/Screen-Shot-2016-12-07-at-00.15.52.png)
...
![](https://swizec.com/blog/wp-content/uploads/2016/12/i-built-a-sfaehy.jpg)
