...
![](https://swizec.com/blog/wp-content/uploads/2017/07/chart.gif)
...
```undefined
<code>2.2.0 :001 > puts Session.last.messages.pluck(:sent_from, :sent_at, :text).to_yaml
- - student
...
```undefined
<code>> moment("2017-07-04 23:00:02.786581000 Z").format('YYYY-MM-DDTHH:mm:ss.SSSSSSS')
