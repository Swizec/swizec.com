...
import { ServerlessHandbook } from "../../../components/FormCK/ContentUpgrades";

Times are changing [name|], the future of web development is here.
...
[Serverless Workshop](https://gum.co/pEmTq) is the best way to dive into serverless cloud functions [name|].
...
[Reserve your spot today](https://gum.co/pEmTq) [name|] and become the future looking expert in your field.
...
[sparkjoy|serverless-workshop-5]
