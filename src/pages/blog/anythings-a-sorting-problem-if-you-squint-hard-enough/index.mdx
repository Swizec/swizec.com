...
![Dataviz fits in a logo](./img/Dataviz-that-fits-in-a-logo1e72d3.gif)
...
![Clickable triangles](./img/Clickable-triangles6eigf0.gif)
...
The code that I've attached here throws intentional errors where I knew it would fail.
...
![Triangle centroid](./img/Triangle-centroid14i743.png)
...
PS: to solve the candle problem, you have to realize that the box is an item separate from thumbtacks. You can use it as a shelf for the candle.