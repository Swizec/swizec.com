...
My final version adds a `useEffect` to animate each triangle independently. You can learn how that works over at [ReactForDataviz.com](ReactForDataviz.com).
...
[![Triangle centroid](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Triangle.Centroid.svg/2560px-Triangle.Centroid.svg.png)](https://en.wikipedia.org/wiki/Centroid)
