...
![Strucla (cake)](./img/Strucla-cake178f7b.jpeg)
...
- moving to not-[wordpress](http://wordpress.org) is a problem because I'd have to migrate plugins, the layout, and so on
- on using _static page generator_ ... my wordpress is configured to do just that, all you see are static pages
- my hosting is free, I like [free stuff](http://FreeStuff4Free.com)
...
## The Story of Being a Free User and Not Buying Enough [Cakes](http://en.wikipedia.org/wiki/Cake)

Everything started last Monday when I said that _[My brain can't handle OOP anymore](https://swizec.com/blog/my-brain-cant-handle-oop-anymore)._ [Reddit](http://reddit.com/) hated the post, mostly resorting to calling me an idiot, but [HackerNews](http://news.ycombinator.com/) was a far more receptive crowd with 53 upvotes and 53 comments. There was a bit of activity on twitter as well.
...
Next morning, joy! Bliss! Heaven! He started, ran rsyinc, I switched around some [IP addresses](http://en.wikipedia.org/wiki/IP_address) and off we go to greener pastures!

In a few minutes accessing the raw domain produced a _[403 error](http://en.wikipedia.org/wiki/HTTP_403)_ and going to /blog gave you a lovely _Error establishing database connection._

![Sunday](./img/2270-1800816503_6147f638fd_m.jpg)
