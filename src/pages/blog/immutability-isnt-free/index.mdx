...
categories: "Javascript, Lessons, Immutability, Array methods"
...
This is one of those stories from the field where theoretical beauty goes out the window and you care about low level JavaScript performance. An afternoon that makes you feel alive as a software engineer 😈
