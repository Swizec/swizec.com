...
We did it! A few thousand elements smoothly animated with React and canvas! Hooray! ![cheering](./img/4OLlufc.gif)

It’s not perfect. We had to throw the baby away with the bath water and drop down a layer below React. The [`updateChildren` issue from last time](https://swizec.com/blog/livecoding-13-rendering-react-components-with-canvas/) proved too hard to solve. Too hard for me to solve at least.
...
![image](./img/JWublnt.gif) It takes 7,000 elements to bog down the pure SVG implementation.

![image](./img/UElqylu.gif) Ugh. So annoying. Back to the drawing board.
