...
It’s not perfect. We had to throw the baby away with the bath water and drop down a layer below React. The [`updateChildren` issue from last time](http://swizec.com/blog/livecoding-13-rendering-react-components-with-canvas/swizec/6784) proved too hard to solve. Too hard for _me_ to solve at least.
