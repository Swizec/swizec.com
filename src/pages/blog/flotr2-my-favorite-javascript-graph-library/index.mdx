...
To visualize [my past year of 750words](https://swizec.com/blog/a-year-of-750words-com-with-shiny-graphs/swizec/4378 "A year of 750words.com – with shiny graphs") I used [Flotr2](http://humblesoftware.com/flotr2/) - it took me ten minutes to go from parsed data dumps to shiny graphs. And that was because I had to come up with a javascript function to mangle my data into something Flotr2 will understand.
