...
swizec.com started with a [test post on April 20th, 2006](https://swizec.com/blog/site-set-up/). Yes, I kept the post. Original design lives in [a time capsule on archive.org](https://web.archive.org/web/20060507223112/http://swizec.com/).
...
Compare the [old homepage](http://old.swizec.com) (a plain html static site, not wordpress), to the [new homepage with far more info](https://swizec.com)
...
Same machinery works in articles. Write markdown same as usual, have support for everything I use in [TechLetter.App](https://teachletter.app), and stop relying on code sample screenshots for the web.
