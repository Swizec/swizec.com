...
hero: ./img/blog-wp-content-uploads-2016-11-decorations.png
---

I made a terrible thing Sunday night.The theme that I bought for [the new React Indie Bundle page](https://swizec.com/blog/livecoding-26-new-page-react-indie-bundle/swizec/7211) has decorations built with SVG. You slap them into the page as `<svg>` tags, and it makes your sections look nice.

![](./img/blog-wp-content-uploads-2016-11-decorations.png)
