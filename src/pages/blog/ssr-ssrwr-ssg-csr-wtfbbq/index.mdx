...
description: "hese abbreviations are getting out of hand. It's like a bad interviewer's wet dream." 
categories: "nextjs, gatsby, technical"
published: 2020-11-24
hero: ./img/screenshot-1606234394207.png
---

These abbreviations are getting out of hand [name|Friend]. It's like a bad interviewer's wet dream.

*"Tell me [name|], what is the difference between rehydrated SSR on a gibson supercomputer with 20kilobytes of RAM versus an SSG SPA on a horizontal supercluster with K8s and a11y?"*
...
Never trust a taxonomy [name|my friend].
...
*You* know the performance characteristics for your project [name|Friend]. There is no solution.
...
Do you care about fast initial loads, useful initial loads, average performance, fastest performance, slowest performance? Depends what you're building [name|].
