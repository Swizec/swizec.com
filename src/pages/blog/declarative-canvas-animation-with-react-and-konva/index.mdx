...
![Marbles](https://swizec.com/wp-content/uploads/2017/02/bouncing-marbles-1.gif)
...
class Marble extends Component {
    ...
    render() {
        ...
        return (
            <Circle x={x} y={y} radius={MarbleR} fillpatternimage={sprite} fillpatternoffset={Marbles[type]} fillpatternscale={{ x: marbler*2, y: marbler*2 }} shadowcolor={Marbles[type].c} shadowblur="15" shadowopacity="1" draggable={draggable} onDragEnd={this.onDragEnd.bind(this)} ref="circle">
        );
    }
}
```
...
![Marbles](https://swizec.com/wp-content/uploads/2017/02/sprite.png)
