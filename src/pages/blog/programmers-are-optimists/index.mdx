...
I'm working on [a web page segmentation algorithm](https://swizec.com/blog/web-page-segmentation/ "Web page segmentation"). The idea is to take a website and decide which parts are headers, sidebars and so on. It's an interesting problem since everyone else is only concerned with extracting the main juicy content.
...
I mean how hard can it be? I'm just using a language I hate (java), am not experienced with, a [paradigm I dislike](https://swizec.com/blog/my-brain-cant-handle-oop-anymore/ "My brain can’t handle OOP anymore") and try to avoid, and a library I only started poking at two weeks ago.
