...
HOCs are great, and I wish I started using them earlier. There's definitely going to be a chapter about HOCs in the [new version of React+D3](https://swizec.com/reactd3js/). Some prime targets for this stuff in there.
