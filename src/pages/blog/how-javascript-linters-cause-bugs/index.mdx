...
![](https://swizec.com/blog/wp-content/uploads/2017/09/DJoDVIiVYAAOcPs.jpg-large.jpeg)

I was doing code review for a coworker yesterday, and it soon became obvious that he used a linter and that the linter gave him a bright idea: _use strict comparisons_.
...
```undefined
<code>function scroll({ elem, offset, duration }) {
...
```undefined
<code>function createWidget(defaultText, onClick, markBusy) {
    new Widget({
        text: defaultText,
        onClick: onClick,
