...
hero: ./img/blog-wp-content-uploads-2017-12-advent-of-code-day-24-graph.jpg
---

On Day 24 of Advent of Code we had to build a path finding algorithm. We're given a set of nodes and a heuristic and have to find the best possible path.<https://twitter.com/Swizec/status/945176148358524929The> puzzle uses different phrasing, but that's what it is.
...
![](./img/blog-wp-content-uploads-2017-12-advent-of-code-day-24-graph.jpg)![](graph)
...
![A\* search algorithm visualization](./img/wikipedia-commons-5-5d-Astar_progress_animation.gif)
...
This _sounds_ a lot like the description of A_, but I'm honestly not sure that my algorithm is A_. 😕
