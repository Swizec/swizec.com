...
![Pillowfights 51](https://swizec.com/wp-content/uploads/2011/09/6192586527_c36407222c_m7.jpg)

In preparation for a blogpost I'm going to make some time this week I found myself wanting to somehow parametrize [vocabulary](http://en.wikipedia.org/wiki/Vocabulary) richness in a piece of text.
...
Unfortunately I don't have the link anymore. It was a seriously random pdf I found online, the title seems to be _"Quantitative [corpus linguistics](http://en.wikipedia.org/wiki/Corpus_linguistics) with R: a practical introduction"_
