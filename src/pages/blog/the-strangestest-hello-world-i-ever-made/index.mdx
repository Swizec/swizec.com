...
- [Le Belem](http://www.flickr.com/photos/48298733@N07/4906662333)
...
Oh also I wanted it to run on Python and be inspired by [Lisp](http://en.wikipedia.org/wiki/Lisp_%28programming_language%29), but without parentheses. No parentheses if at all avoidable!
...
Everything that sticks together is considered a paragraph of code and will essentially evaluate to a big [function composition](http://en.wikipedia.org/wiki/Function_composition) like so f(g(h(x))). Ok? ok.
