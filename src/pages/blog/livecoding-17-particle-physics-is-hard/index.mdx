...
The formula he gave says that force between a static charge and a particle is equal to `1/r^2`, where `r` is the euclidean distance between two points. We get it using Pythagorus’ formula:
