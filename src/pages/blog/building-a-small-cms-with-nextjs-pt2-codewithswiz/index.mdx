...
hero: ./img/screenshot-1599145893288.png
categories: "CodeWithSwiz, Livecoding, Technical"
---

*CodeWithSwiz is a twice-a-week live show. Like a podcast with video and fun hacking. Focused on experiments. [Join live Wednesdays and Sundays](https://youtube.com/swizecteller)*
...
![Hero link shows up in frontmatter](https://i.imgur.com/gXTYsa8.png)
...
![techletter.app machinery in action](https://i.imgur.com/d2w4Uhi.gif)
...
![An error message in NextJS](https://i.imgur.com/AwTIlJv.png)
