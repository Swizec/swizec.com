...
![List structure](http://swizec.com/blog/wp-content/uploads/2012/08/list-structure.png "List structure")
...
![((A · B) · (C · (E · F)))](http://swizec.com/blog/wp-content/uploads/2012/08/example-list-structure.png "((A · B) · (C · (E · F)))")
...
![Association list for "DIFFERENTIATE"](http://swizec.com/blog/wp-content/uploads/2012/08/association-list.png 'Association list for "DIFFERENTIATE"')
