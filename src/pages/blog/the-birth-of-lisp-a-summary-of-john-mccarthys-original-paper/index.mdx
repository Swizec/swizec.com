...
So an S-expression is any ordered pair of S-expressions. Strictly speaking we are supposed to terminate any nesting of S-expressions with a _[NIL]\(<http://en.wikipedia.org/wiki/NIL>_%28programming*language%29 "NIL (programming language)")*, but we agree that _(m)_ stands for _(m_ · NIL) \_\_and that instead of a dot operator we can write expressions as lists, which makes our lives a lot easier
...
![List structure](https://swizec.com/wp-content/uploads/2012/08/list-structure.png "List structure")
...
![((A · B) · (C · (E · F)))](https://swizec.com/wp-content/uploads/2012/08/example-list-structure.png "((A · B) · (C · (E · F)))")
...
![Association list for "DIFFERENTIATE"](https://swizec.com/wp-content/uploads/2012/08/association-list.png 'Association list for "DIFFERENTIATE"')
...
Another interesting observation is that talking about **representation of S-functions by Programs** McCarthy ever so casually introduces lazy evaluation by saying that compilation is simple and _"conditional expressions must be so compiled that only the \_p's_ and _e's_ that are required are computed"\_
...
Now if only there weren't so many damn parentheses ... [I tried to learn LISP (clojure really)](https://swizec.com/blog/tag/clojure), I really did. But the syntax was just too jarring.

###### Related articles

- [![](https://i.zemanta.com/102977749_80_80.jpg)](http://passionsjustlikemine.wordpress.com/2012/07/27/john-mccarthy-in-the-literary-arena/)[John McCarthy in the Literary Arena](http://passionsjustlikemine.wordpress.com/2012/07/27/john-mccarthy-in-the-literary-arena/)
- [![](https://i.zemanta.com/noimg_97_80_80.jpg)](http://blog.fogus.me/2012/07/25/some-lisp-books-and-then-some/)[Some Lisp books (and then some)](http://blog.fogus.me/2012/07/25/some-lisp-books-and-then-some/)
- [![](https://i.zemanta.com/noimg_3_80_80.jpg)](http://nic.ferrier.me.uk/blog/2012_07/tips-and-tricks-for-emacslisp)[Tips and tricks with emacslisp for fun and profit](http://nic.ferrier.me.uk/blog/2012_07/tips-and-tricks-for-emacslisp)
- [![](https://i.zemanta.com/101202848_80_80.jpg)](http://www.drdobbs.com/tools/developers-reading-list/240003875)[Developer's Reading List](http://www.drdobbs.com/tools/developers-reading-list/240003875)
- [![](https://i.zemanta.com/noimg_46_80_80.jpg)](http://kresimirbojcic.com/2012/08/14/why-lisp-did-not-and-never-will-gain-enough-traction.html)[Why Lisp Did Not and Never Will Gain Enough Traction](http://kresimirbojcic.com/2012/08/14/why-lisp-did-not-and-never-will-gain-enough-traction.html)

[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=27a245ba-8da2-4b42-a319-61686149e5a2)](http://www.zemanta.com/?px "Enhanced by Zemanta")
