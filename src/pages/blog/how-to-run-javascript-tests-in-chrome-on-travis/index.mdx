...
![Pull request feedback](./img/images-26240.png)
...
[Chrome](http://en.wikipedia.org/wiki/Google_Chrome) is the only option.
...
Then we use `karma.conf.js` to let Karma know, we need a special browser for Travis.
...
![Karma success](./img/images-26241.png)
