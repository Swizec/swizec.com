...
As I hinted earlier, we render an SVG path element. The shape definition – `d` – comes from `this.arc` and some data, and the color comes from `this.props.color`. You can render a piechart now. Wonderful, isn’t it? :) ![Screen Shot 2016-04-12 at 02.08.26](http://swizec.com/blog/wp-content/uploads/2016/04/Screen-Shot-2016-04-12-at-02.08.26-300x118.png)
