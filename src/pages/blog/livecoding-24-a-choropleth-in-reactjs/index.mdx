...
![](./img/A9CQw9a.png "livecoding output first image")

Into this picture:

![](./img/REu8pM0.png "livecoding output second image")
...
const County = ({ data, geoPath, feature, quantize }) => {
    ...
    return (<path d={geoPath(feature)} style="{fill: color}" title={feature.id}></path>)
};
