...
![Spark Joy feedback widgets in email](./img/Spark-Joy-feedback-widgets-in-email980e59.png "Spark Joy feedback widgets in email")
...
![sarcastic wow](./img/sarcastic_wow.gif "sarcastic wow")
