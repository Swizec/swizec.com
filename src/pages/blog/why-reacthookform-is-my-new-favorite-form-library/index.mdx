...
![loser giphy](./img/media-mcH0upG1TeEak-giphy.gif "loser giphy")
...
![love giphy](./img/media-26FLdmIp6wJr91JAI-giphy.gif "love giphy")
...
![on change validation](./img/8OoC3l4.gif "on change validation")
...
![on blur validation](./img/DnFojjm.gif "on blur validation")
...
![context sweep](./img/t10OP3q.gif "context sweep")
...
![excited giphy](./img/media-UO5elnTqo4vSg-giphy.gif "excited giphy")
...
![complete address validation](./img/SrY8mvc.gif "complete address validation")
...
![peace giphy](./img/media-xUPGcyuPRNjODvvOFO-giphy.gif "peace giphy")
