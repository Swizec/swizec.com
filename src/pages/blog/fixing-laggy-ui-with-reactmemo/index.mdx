...
![typing full speed](./img/VlpnEbl.gif)

Yeah, real bad. 🙈

After a few small tweaks tho ...

![After few tweaks](./img/ihNGHUN.gif)
...
[Click me to play with code](https://codesandbox.io/s/n7zlz8onj0)
...
![Before optimisations](./img/media-D11LdPWUcAA6SVw.png)

![After optimisations](./img/media-D11Lj3MVYAAdZ6E.jpg)
