...
A quick Google search reveals a bunch of solutions do in fact exist, but [Stringex](https://github.com/rsl/stringex) comes out as the best solution for [Ruby](http://www.ruby-lang.org/). There should be plenty for any language you love.
...
[Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=08b189ad-699b-42e3-b0db-11bebd9babfd)