...
![English: The Haskell Logo, a stylized >λ= . Th...](https://swizec.com/wp-content/uploads/2011/12/300px-Haskell-Logo.svg_4.png)

A couple of days ago I decided that doing my graduation thesis on a topic that, when suggested, brought a sparkle to my mentor's eye and made him suggest I might want to think about picking a co-mentor just wasn't hard enough - so I decided to do the whole thing in [Haskell](http://haskell.org).
...
The first thing I noticed is just how bloody expressive Haskell is, it feels like I'm writing much less code than I'm used to in both [JavaScript](http://en.wikipedia.org/wiki/JavaScript) and [Python](http://www.python.org/) to achieve cool stuff. Definitely less than when I was trying to learn Clojure by just perusing the docs.
