...
One of the many interesting things [Github](https://github.com "GitHub") does are punchcards for repositories that can tell you when people work on their code. Unfortunately, they're only per-repository and I was interested in per-user Github punchcards.
