...
Friend, this episode of #CodeWithSwiz was a great example of why you want to start using TypeScript and how thermal load _destroys_ computers.
...
![NextJS shows a cryptic error](https://i.imgur.com/1TUlK6G.png)
...
![Prettifying compiled source to spot bugs](https://i.imgur.com/kcWpEtO.gif)
