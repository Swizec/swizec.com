...
Hell, you could just forget to fill up your credit card and get your access revoked. Things happen ¯_(ツ)_/¯
...
I wrote about [building distributed transactions](https://swizec.com/blog/always-put-side-effects-last/swizec/8057) before. Correctness across multiple services is _really_ hard to ensure.
