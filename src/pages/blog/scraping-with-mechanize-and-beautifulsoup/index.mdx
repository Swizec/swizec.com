...
![Scraping](./img/Scraping754128.jpeg)
...
When you're done, you will lie awake at night, praying to the gods of the internets, hoping nobody sneezes at the [HTML](http://en.wikipedia.org/wiki/HTML) of that page.
...
At least [BeautifulSoup](http://www.crummy.com/software/BeautifulSoup/) makes browsing [DOM](http://en.wikipedia.org/wiki/Document_Object_Model) a breeze:
