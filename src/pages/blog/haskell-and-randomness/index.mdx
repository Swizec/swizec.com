...
![A row of businesses in downtown Haskell.](https://upload.wikimedia.org/wikipedia/en/thumb/8/89/Haskell_wiki.JPG/300px-Haskell_wiki.JPG)

To get my feet wet I decided to write a basic framework for [evolutionary algorithms](http://en.wikipedia.org/wiki/Evolutionary_algorithm) in [Haskell](http://haskell.org). Nothing too major, just a way to easily assemble different evaluation, mutation and selection functions.

For starters I'm going to evolve a _"[Hello World!](http://en.wikipedia.org/wiki/Hello_world_program)"_ string. How hard could it be? Took me [an hour to evolve a poem in python](https://swizec.com/blog/evolving-a-poem-with-an-hour-of-python-hacking/) based on character mutations ...
