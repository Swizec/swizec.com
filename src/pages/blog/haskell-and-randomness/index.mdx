...
For starters I'm going to evolve a _"[Hello World!](http://en.wikipedia.org/wiki/Hello_world_program "Hello world program")"_ string. How hard could it be? Took me [an hour to evolve a poem in python](https://swizec.com/blog/evolving-a-poem-with-an-hour-of-python-hacking/swizec/1505) based on character mutations ...
...
- [![](https://i.zemanta.com/94978044_80_80.jpg)](https://swizec.com/blog/why-i-still-havent-learned-haskell/swizec/4663)[Why I still haven't learned Haskell](https://swizec.com/blog/why-i-still-havent-learned-haskell/swizec/4663)
