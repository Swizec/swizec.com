...
![A row of businesses in downtown Haskell.](http://upload.wikimedia.org/wikipedia/en/thumb/8/89/Haskell_wiki.JPG/300px-Haskell_wiki.JPG "A row of businesses in downtown Haskell.")
