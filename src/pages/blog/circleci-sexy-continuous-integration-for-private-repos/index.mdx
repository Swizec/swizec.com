...
![CircleCI dashboard](https://www.filepicker.io/api/file/PI3LtjaZQRaz2ZB2GOfM)

The first thing we fixed at [Dwellers](http://dwellers.com), was setting up a [continuous integration](http://en.wikipedia.org/wiki/Continuous_integration) service on the very first day. I've never worked with an environment that makes sure all my tests are passing and pushes things into staging before. I tried a few years ago, but it was a bitch to set up and never worked.

It sucks.

Sure I run tests all the time, and have no problem deploying to a server - especially [Heroku](http://www.heroku.com/) where you just do a `git push heroku`. But it's tedious and the less things you have to think about, the more brain cycles are free to solve actual problems.

Initially I suggested using [TravisCI](https://travis-ci.org/) but they _still_ don't support private repositories. Luckily we found [CircleCI](https://circleci.com/). It focuses exclusively on private [Github](http://github.com) repositories. Perfect.
...
![A CircleCI test run](https://www.filepicker.io/api/file/tu573fdfRCKQQjlrS2hz)
...
![Test badges in branch list](https://www.filepicker.io/api/file/bzq7m0YxTaCLMzn39JaZ)
...
![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=553a99a5-d1b7-4c28-86e9-1bf2c0ed3a40)