...
Sometimes you fall into the `[Deep Backend](https://swizec.com/blog/in-2020-what-is-frontend/#backend-of-the-frontend-vs-deep-backend)` and that's a dark place. You get your telemetry, a stream of data, a large database, and your job is to make sure they match at 99.999% consistency without data loss.
...
You have to set up a server, make sure it stays up, set up Nginx or Apache reverse proxies, configure a database, make sure _that_ stays running, configure permissions, muck around with Docker, drop into Unix commands, set up monitoring, configure domains, set up a CDN for static files,//etc..

Then you're ready to write your code.

Publish to Reddit and your server dies under load 🤦‍♂️

![screw_that](https://media.giphy.com/media/3osgU812hQzJvWh18e/giphy.gif)
...
You're standing one foot in the future, one foot in the past. We all are. How we build web apps is changing.
...
![im_in_love](https://media.giphy.com/media/uNu0weAFOMMFy/giphy.gif)
