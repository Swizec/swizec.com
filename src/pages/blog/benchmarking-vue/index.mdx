...
![The Vue benchmark component](https://swizec.com/blog/wp-content/uploads/2018/03/component-screenshot.png)
...
```undefined
<code>yarn add vue vue-loader vue-template-compiler
</code>
```
