...
---
A few months ago I inherited a Kotlin project. It was an unfinished prototype and all I had to do was wrap it up and deploy. How hard can it be?https://twitter.com/Swizec/status/1103070682248704002Weeks passed. Even months. Every time I touched the project, it broke. Nothing worked. Wouldn&#x27;t run on my machine, wouldn&#x27;t read API requests, couldn&#x27;t get tests working, if I changed some code I broke it all. That&#x27;s when I realized [Learning a new field is super hard](https://swizec.com/blog/learning-a-new-field-is-super-hard-i-get-it-now-%F0%9F%98%85/swizec/8974) 😅
