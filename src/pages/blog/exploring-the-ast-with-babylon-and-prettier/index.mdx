...
![Root `file` node, child `program` node.](https://swizec.com/wp-content/uploads/2017/06/fileprogram1.png)
...
![variableDeclaration node picture](https://swizec.com/wp-content/uploads/2017/06/image2.png)
