...
Let's say you are writing an application in [Ruby](http://www.ruby-lang.org/). You are probably talking to every API under the sun and are happily writing tests to make sure your code isn't failing.
...
## Enter [Javascript](http://en.wikipedia.org/wiki/JavaScript), stage left
...
Launch a headless browser, click around the site from the comfort of [RSpec](http://rspec.info/), make sure users see what they're supposed to. Balance restored.
