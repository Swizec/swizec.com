...
MobX is a state management competitor to Redux, by the way. I like it because there's almost no boilerplate. We've been using it at The Day Job™ and it's been amaze so far.
