...
A few days ago I wrote about [upgrading my linux box to Ubuntu Natty Narwhal](https://swizec.com/blog/even-with-narwhals-ubuntu-is-still-a-bitch-to-install/ "Even with Narwhals ubuntu is still a bitch to install") and mentioned that I hate the new user experience the system offers.
