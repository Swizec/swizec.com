...
---
You should always keep development and production separate my friend, but how do you pull that off when everyone has your back and tries to keep your app secure?wait what 🤨Here&#x27;s the problem 👉You&#x27;ve built a cool app. Static JAM on the frontend, Serverless functions on the backend, nearly free to host, super fast to load. It&#x27;s amazing and you&#x27;re proud as heck.Time to show off!![show_off giphy](./img/media-QugrBeDxEFuDfooN11-giphy.gif)
