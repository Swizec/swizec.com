...
When [Rails](http://rubyonrails.org "Ruby on Rails") first came out, I was still a [PHP](http://www.php.net "PHP") guy. Slaving away at a web agency, pushing out website after website and letting designers have all the fun.![Ruby t-shirt](https://cache1.bigcartel.com/product_images/71294019/Ruby_CBGB_Red_lg.png "Ruby t-shirt")
...
![rails in de sneeuw](./img/1307-5184860600_62f1e5dacb_m.jpg "rails in de sneeuw")
...
![Dejanews MemeGraph For: 'Perl vs PHP vs Python...](./img/12-18380160_3b9f657690_m.jpg "Dejanews MemeGraph For: 'Perl vs PHP vs Python...")

So far I've always been used to explicitly defining imports, explicitly calling a function from this library or that. You never do _import \*_ and yet with Ruby, that's all you get. _Everything_ is an import \* and more often than not, it redefines the behaviour of the language itself.
...
- [![](https://i.zemanta.com/141569793_80_80.jpg)](http://www.cio.com/article/727806/Ruby_on_Rails_Receives_the_Third_Security_Patch_in_Less_Than_a_Month?source=rss_security)[Ruby on Rails Receives the Third Security Patch in Less Than a Month](http://www.cio.com/article/727806/Ruby_on_Rails_Receives_the_Third_Security_Patch_in_Less_Than_a_Month?source=rss_security)
- [![](https://i.zemanta.com/noimg_90_80_80.jpg)](http://blog.daemonl.com/2013/02/forcing-myself-to-learn-ror.html)[Forcing myself to learn RoR](http://blog.daemonl.com/2013/02/forcing-myself-to-learn-ror.html)
- [![](https://i.zemanta.com/143333734_80_80.jpg)](http://gilesbowkett.blogspot.com/2013/02/nodejs-hatred-reveals-significant.html)[Node.js Hatred Reveals Significant Dysfunction In The Ruby Culture](http://gilesbowkett.blogspot.com/2013/02/nodejs-hatred-reveals-significant.html)
- [![](https://i.zemanta.com/141624022_80_80.jpg)](http://nerds.airbnb.com/weve-launched-our-first-nodejs-app-to-product)[Our First Node.js App: Backbone on the Client and Server](http://nerds.airbnb.com/weve-launched-our-first-nodejs-app-to-product)
- [![](https://i.zemanta.com/143236954_80_80.jpg)](http://thinkinginrails.com/2013/02/why_choose_rails/)[Why Choose Ruby on Rails](http://thinkinginrails.com/2013/02/why_choose_rails/)

[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=b780ad15-de34-479a-8c04-1683f4dfcfa5)](http://www.zemanta.com/?px "Enhanced by Zemanta")
