...
description: "Behind the scenes of a vendor migration project. Here's what your senior+ engineers do so you can focus on the code."
published: 2023-03-24
hero: ./img/screenshot-1679672794724.png
---

[name|Friend], tutorials make every project look easy. You start at the beginning and code your way to the end. Wonderful.
...
[name|], enterprise sales _sucks_. Even from the buyer's perspective. We spent 6+ hours in demo after demo making sure this new vendor can do what we need, do it well, and isn't selling promises from the backlog.
...
I did not fully explain the consequences to all stakeholders [name|]. I didn't even realize who all the stakeholders were. People high up in the company got upset when their dashboards dropped to zero.
...
Notice the miscommunication [name|]? Yeah it's a big one.
