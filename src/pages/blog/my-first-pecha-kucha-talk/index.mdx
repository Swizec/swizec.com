...
A few weeks ago I delivered my first ever [Pecha Kucha](http://en.wikipedia.org/wiki/Pecha_Kucha) talk.

Pecha Kucha works a little bit like [Ignite](http://en.wikipedia.org/wiki/Ignite_%28event%29) with a few tweaks. You have to give a short talk consisting of 20 slides, where every slide automatically changes to the next one every 20 seconds. This gives you a talk that is 400 seconds or 6 minutes 40 long.
...
But hey, apparently I'm doing another thing similar to this in [Belgrade](http://maps.google.com/maps?ll=44.8205555556,20.4622222222&spn=0.1,0.1&q=44.8205555556,20.4622222222%20(Belgrade)&t=h) on the 31st of August. That should be fun.
