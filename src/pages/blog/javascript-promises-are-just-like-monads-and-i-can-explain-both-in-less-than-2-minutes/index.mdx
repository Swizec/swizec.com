...
<https://youtu.be/KVYm0qC4b1YThere's> a joke in functional programming that once you understand monads, it becomes impossible to explain them to others. The [amount of monad tutorials on the internet](https://wiki.haskell.org/Monad_tutorials_timeline) is growing almost exponentially 😁
...
![continuation monad](./img/continuation-monadbcjeeh.svg)
