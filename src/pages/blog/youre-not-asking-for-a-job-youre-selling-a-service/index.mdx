...
Job interviews suck [name|]. You go in there, solve a few puzzles, get a little hazing, and never hear from them again.
...
[![Slope makes up for y-intercept](https://raw.githubusercontent.com/HealthAPI/helmet/develop/docs/img/slope_vs_y-intercept.png)](https://gist.github.com/gtallen1187/e83ed02eac6cc8d7e185)
...
**You** are the expert [name|my friend]. You've seen this before, you know how it goes, you know what breaks before it breaks. You can see it coming a mile away and code or architect defensively.
...
With that in mind, how would _you_ sell a $700,000 product [name|]? How would you buy it? 🤔
...
You're not asking for a job, you're selling a service. A professional never begs [name|my friend]. ❤️
