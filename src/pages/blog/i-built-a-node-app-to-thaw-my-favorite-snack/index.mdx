...
<https://twitter.com/Swizec/status/1050142413468000256?ref_src=twsrc%5Etfw>
...
<https://twitter.com/Swizec/status/1050288715178770432?ref_src=twsrc%5Etfw>
...
```undefined
<code>async function thawMyCarrots(targetTemp) {
...
```undefined
<code>function mySlowFunction(baseNumber) {
