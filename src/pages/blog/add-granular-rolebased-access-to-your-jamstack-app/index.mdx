...
---
Say you&#x27;ve got a JAMStack app with authentication. Works great, loads fast, some pages need login. That part&#x27;s easy with something like [useAuth](https://github.com/Swizec/useAuth), a manual integration with Auth0, or any number of 3rd party providers.
...
Here&#x27;s an article I wrote on [Connecting Gumroad to Auth0 for paywalled JAMStack apps](https://swizec.com/blog/connecting-gumroad-to-auth0-for-paywalled-jamstack-apps/swizec/9336) ❤️
...
Full details in the [Connecting Gumroad to Auth0 for paywalled JAMStack apps](https://swizec.com/blog/connecting-gumroad-to-auth0-for-paywalled-jamstack-apps/swizec/9336) article.
...
PS: the [coding-on-a-ipad workflow I suggested on Friday totally worked](https://swizec.com/blog/looking-for-the-perfect-light-work-device/swizec/9413) 🤘
