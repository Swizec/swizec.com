...
hero: ./img/1hh3ii.jpg
---
https://twitter.com/erikthedev/status/818990904929349632Webpack 2.2 has reached [release candidate 4](https://github.com/webpack/webpack/releases/tag/v2.2.0-rc.4), the last pre-release version. Time to update!
