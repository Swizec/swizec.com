...
[Funny engineer spelling](./img/Funny-engineer-spelling1f9c06.jpeg)

A couple weeks ago I published a visualization of [H1B](http://en.wikipedia.org/wiki/H-1B_visa) salaries in the [software industry](http://en.wikipedia.org/wiki/Software_industry). You should check it out, [here](http://swizec.github.io/h1b-software-salaries/#2014-ca-engineer).
...
But let's give people some credit, engineer is a pretty darn difficult word to spell. It's practically latin throws the usual [English phonetics](http://en.wikipedia.org/wiki/English_phonology) out the door.
...
And once more, a bunch of datapoints using it as a prefix ... maybe that's my bad though. Surely it's my bad. Surely it just means `.split()` isn't the best word [tokenizer](http://en.wikipedia.org/wiki/Lexical_analysis).
