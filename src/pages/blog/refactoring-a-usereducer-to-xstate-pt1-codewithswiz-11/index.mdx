...
`useAuth` was always meant to become _the_ best way to add authentication to your React and JAMStack apps. Regardless of auth provider.
...
[![Eric Hodges contribution](./img/kHQSi9pngi2389a.png)](https://chakra-ui-test-delta.now.sh/)
