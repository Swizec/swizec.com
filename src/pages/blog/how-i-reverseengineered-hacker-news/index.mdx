...
![Post image](./img/photos-images-original-000-415-209-3b4.png)
...
![Login form](https://swizec.com/wp-content/uploads/2017/08/login-screenshot.png)
...
![Code snippet](https://swizec.com/wp-content/uploads/2017/08/code-screenshot.png)
...
![Preserve logs checkbox](https://swizec.com/wp-content/uploads/2017/08/preserve-logs.png)

As we assumed, the login request sends `goto`, `acct`, and `pw`, and sets a cookie.

![Login request](https://swizec.com/wp-content/uploads/2017/08/login-request-screenshot.png)

---

Inspecting the upvote request follows a similar process. This is what we find:

![Upvote request](https://swizec.com/wp-content/uploads/2017/08/upvote-request-screenshot.png)
...
![Mr. Robot](https://swizec.com/wp-content/uploads/2017/08/mr-robot.jpg)
