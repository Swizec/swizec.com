...
![D3 Example1](./img/tNfXLwD.gif)

And like this

![D3 Example2](./img/Djk8yKX.gif)

D3 can even do 3D globe effects like this 😱

![D3 Example3](./img/24R4Mll.png)
...
![Describe the GIF](./img/media-dgKrQw280pFGsAa1ld-giphy.gif)

I took my idea and looked for a dataset. Some people have the dataset first. That's probably smart.

And then ...

![Describe the GIF](./img/media-WxKe34zkYomreUH1XH-giphy.gif)
...
![Result Image 1](./img/9echESi.png)

![Result Image 2](./img/media-a0h7sAqON67nO-giphy.gif)
...
![Code Image](./img/static-barchartcode-6fbc274eed4cba9b32493cab9607ff61-d9514.png)

Doesn't make a lot of sense does it? How does that 👆 create this 👇

![Bar Chart](./img/9echESi.png)

Here's how.

First you have Data Manipulation.

![Dat Manipulation Image](./img/static-barchartcode-data-b62f3f758e2a1b37cb436d66a54846d1-d9514.png)
...
![DOM Manipulation Image](./img/static-barchart-dom-0d48cb4e05c4cbfcf2201b136ba2e6e3-d9514.png)
...
![Function Diagram](./img/wikipedia-commons-thumb-d-df-Function_color_example_3.svg-440px-Function_color_example_3.svg.png)
...
![Great Success](./img/media-65HMb0y6hAxiyezDbC-giphy.gif)
