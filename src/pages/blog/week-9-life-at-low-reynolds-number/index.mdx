...
Have you ever wondered how [micro-organisms](http://en.wikipedia.org/wiki/Microorganism) can just live in a drop of water like that? I have and now I have an answer.
...
But at the [microscopic scale](http://en.wikipedia.org/wiki/Microscopic_scale), for something like a paramecium or a bacteria, the 'Re' of water will go as far down as 10-4. At that scale, inertia simply stops existing.
...
![Scallop theorem](./img/images-5750.png)
...
Perhaps even more surprisingly, [E. Coli](http://en.wikipedia.org/wiki/Escherichia_coli) uses its flagellum as a corkscrew. It's odd for a living organism to have a rotary motor and joint, but experiments performed by Silverman and Simon showed this is the case.
...
![Velocity components of glued E. Coli](./img/images-5781.png)
...
![Corkscrew as a matrix](./img/images-5782.png)
...
![1% efficiency of a corkscrew](./img/images-5783.png)
...
![Movement patterns of E. Coli](./img/images-5786.png)
...
![Outrunning diffusion](./img/images-5787.png)
