...
[Productivity, by koalazymonkey](http://www.flickr.com/photos/koalazymonkey/4643421882/)

As a budding [programmer](http://en.wikipedia.org/wiki/Programmer), I could spend an hour programming and within that hour I learned so much the next hour was like three sets of the first combined.
...
With a bit of smoothing you'd still get a roughly [exponential curve](http://en.wikipedia.org/wiki/Exponential_growth).

As Ralph W. Sockman, whomever he is, once said _"The larger the island of knowledge, the longer the shoreline of wonder."_

[Experience deepens a specialty](./img/articles-phd-school-in-pictures-images-PhDKnowledge.005.jpg)
...
[Hacking takes you to the edge of knowledge](./img/articles-phd-school-in-pictures-images-PhDKnowledge.006.jpg)
...
And no, that's not because I spent so much time checking [Twitter](http://twitter.com), [Reddit](http://reddit.com/), [HackerNews](http://news.ycombinator.com/), [Facebook](http://facebook.com) and email. I optimized those problems out of my work time when I started using [the pomodoro technique](https://swizec.com/blog/living-life-in-25min-increments/) about a year ago. A _huge_ boon to productivity.
...
[You release an opensource thingy](./img/articles-phd-school-in-pictures-images-PhDKnowledge.009.jpg)
...
[But in the grand scale of things ...](./img/articles-phd-school-in-pictures-images-PhDKnowledge.012.jpg)
