...
When I started migrating in September 2019, there were no good scripts. Best I could find was somebody's 7 year old college project – [wordpress-to-markdown](https://github.com/DengYiping/wordpress-to-markdown).
