...
![](./img/blog-wp-content-uploads-2016-11-vanilla-dropdown.gif)
...
![](./img/blog-wp-content-uploads-2016-11-react-virtualized-select.gif)
...
I don't know if it would work with Redux. As long as you're careful about the reference thing, you should be fine.But is it a good idea?Yes. Use this approach for all select fields. Even the small ones! There's no harm, and it's faster. Winning.
```