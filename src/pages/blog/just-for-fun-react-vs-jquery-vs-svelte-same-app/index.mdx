...
![memory_lane](./img/media-kcSG1rpAKxpao-giphy.gif)
...
![magic](./img/media-12NUbkX6p4xOO4-giphy.gif)
...
The script looks similar to React Hooks. You got some variables with state and you got a `moreCats` function that drives it.
