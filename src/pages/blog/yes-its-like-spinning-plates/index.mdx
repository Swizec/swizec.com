...
![](https://media1.tenor.com/m/9b9cUZ-lse4AAAAd/spinning-plates.gif)
...
Your job isn't to *fix* things, it's to stack rank priorities, get the next biggest fire under control, and move on. Once your [fire is small enough to let burn](https://swizec.com/blog/let-small-fires-burn/), the next one needs you.
