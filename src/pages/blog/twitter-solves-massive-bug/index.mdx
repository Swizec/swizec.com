...
Today I resolved a bug lurking deep within the workings of my [Chlorine Boards framework](http://chlorineboards.swizec.com/) and I have [twitter](http://twitter.com) to thank. When I made a blogpost about how [drug use is not abuse](https://swizec.com/blog/drug-use-is-not-abuse/2/374) a person following me on twitter immediatelly picked up on the post, gave it a read, retweeted and wanted to leave a comment. But couldn't. Immediately [@OneLuvGurl](http://twitter.com/OneLuvGurl) tweeted to me about how she can't comment.
