...
Today I resolved a bug lurking deep within the workings of my Chlorine Boards framework and I have [twitter](https://twitter.com/Swizec) to thank. When I made a blogpost about how [drug use is not abuse](https://swizec.com/blog/drug-use-is-not-abuse/) a person following me on twitter immediatelly picked up on the post, gave it a read, retweeted and wanted to leave a comment. But couldn't. Immediately [@OneLuvGurl](https://twitter.com/OneLuvGurl) tweeted to me about how she can't comment.
...
This event just goes to show how much more than just status updates [Twitter](https://twitter.com) has become and just how awful bugs can be.
