...
Say you want to lazy load some images on your website. You don't want them to just pop into existence and scare the user. A nice fade in effect works much better.![](./img/blog-wp-content-uploads-2018-01-gif.gif)
