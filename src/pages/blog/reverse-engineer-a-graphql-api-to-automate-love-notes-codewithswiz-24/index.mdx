...
![List of API requests in Charles Proxy](./img/List-of-API-requests-in-Charles-Proxy1f47e3.png)
...
GraphQL mutation in the request looks like this:
...
![Blue fish on the box](./img/Blue-fish-on-the-boxd3dgf5.png)
