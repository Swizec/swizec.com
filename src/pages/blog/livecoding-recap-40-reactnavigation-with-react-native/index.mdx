...
redirect_from:
  - /blog/livecoding-recap-40-react-navigation-react-native/swizec/7640
...
https://www.youtube.com/watch?v=OFx8tMvpNj0

This weekend, I wanted to try out [`react-navigation`](https://reactnavigation.org/) because I've heard a lot about it. Supposed to be the big new (official) thing since `Navigator` was deprecated in April.
...
![](https://swizec.com/wp-content/uploads/2017/06/travel-app.gif)

Pictures are from Flickr. I figured out how to do that in [my Music App tutorial](https://school.shoutem.com/lectures/build-react-native-music-app-tutorial-part1/). Maybe I should make an opensource "show random pretty pic from Flickr" component. Seems useful 🤔
...
Either way, expect an in-depth tutorial about all of this on [reactnative.school](reactnative.school) come Tuesday. Maybe Wednesday if I decide to wait for my new laptop to arrive.

Really, the hardest part of today's livecoding was dealing with my computer. Damn thing is so slow when running OBS and [connecting to my DSLR](https://swizec.com/blog/this-is-how-i-connected-my-canon-dslr-as-a-webcam/) that it took 15 minutes to compile the initial blank app.
...
https://www.youtube.com/watch?v=ZNU29JfzKOI
