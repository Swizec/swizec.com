...
With AI at your side, it's going to be easier than ever to [own the outcome, not the work](https://swizec.com/blog/how-to-own-projects-like-a-senior-engineer/#own-the-outcome-not-the-work). In a way it's like [hiring interns](https://swizec.com/blog/the-surprising-benefit-of-hiring-interns-to-write-your-code/) to help with the boring parts you've built before.
