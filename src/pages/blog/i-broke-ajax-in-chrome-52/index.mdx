...
![Success wrapper doesn&#x27;t fire](./img/blog-wp-content-uploads-2016-08-success-wrapper.gif)
...
![Bug without Backbone](./img/blog-wp-content-uploads-2016-08-purer-bug.gif)

? It worked! 8 lines of code reproduce the bug. ?

And yes, both requests happen without error.

![Network calls do happen](./img/blog-wp-content-uploads-2016-08-bug-network.gif)
...
![Superagent repros too](./img/blog-wp-content-uploads-2016-08-superagent-bug.gif)
