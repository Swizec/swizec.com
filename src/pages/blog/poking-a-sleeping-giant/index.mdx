...
The first [postcard](http://en.wikipedia.org/wiki/Postcard) is said to have appeared in 1840 - it was a hand painted design on a piece of thick paper, sent with a penny black stamp to the writer [Theodore Hook](http://en.wikipedia.org/wiki/Theodore_Hook).

![First postcard](https://swizec.com/wp-content/uploads/2011/11/Conlie_postcard.jpg)

Since then not much has changed, the stock image postcards appeared in1848 as part of some sort of advertising. The modern postcard was born around 1870 when [Camp Conlie](http://en.wikipedia.org/wiki/Camp_Conlie) started offering stock postcards with photos of the place to send home as a memory.
...
When my friend had a birthday two weeks ago she didn't get a single [greeting card](http://en.wikipedia.org/wiki/Greeting_card). She got ten silly pictures on facebook and somebody even made her a custom rage comic. That's right, a rage comic just to wish her a happy birthday.
