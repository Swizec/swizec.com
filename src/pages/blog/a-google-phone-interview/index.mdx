...
Mind you, I don't know whether I actually want to work for Google. They're a huge company and working for them would fly right in the face of [my principle to only work with startups](https://swizec.com/blog/why-i-only-work-with-startups/swizec/2936 "Why I only work with startups")! On the other hand, just being able to say I've worked at Google, even for a short while, would look _incredibly_ well on my CV.
