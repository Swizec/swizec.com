...
---
About a month ago I wrote about [Adding granular role-based access to your JAMStack app](https://swizec.com/blog/add-granular-role-based-access-to-your-jamstack-app/swizec/9418). That worked okay.
...
PS: scopes get into your users [the same way roles do](https://swizec.com/blog/add-granular-role-based-access-to-your-jamstack-app/swizec/9418). You add them through the Auth0 API or UI and use a bit of Auth0 JavaScript to inject it into user properties on every request.