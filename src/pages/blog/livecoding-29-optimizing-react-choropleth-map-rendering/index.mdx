...
Yesterday was supposed to be all about cutting up a large-ish codebase into small chunks that are easier to explain step-by-step. It was a great plan, but it didn't _quite_ happen.
