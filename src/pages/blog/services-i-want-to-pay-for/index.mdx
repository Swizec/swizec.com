...
[Good Dickens! It's a Wenlock! via miksago](https://distilleryimage11.s3.amazonaws.com/1ae7a724f0c211e1b55e22000a1e9610_6.jpg)
...
- A tool that reminds me to keep in touch with potential clients (some sort of [CRM](http://en.wikipedia.org/wiki/Customer_relationship_management) I guess)
- According to my personal metrics - give me progress [predictions](http://en.wikipedia.org/wiki/Prediction) with graphs and advice on improving
- A helper for building good habits so I can just respond to events rather than use my own willpower
- Unified way of dealing with all the apps/services that have my CreditCard or [PayPal](http://paypal.com) info
- Unified directory of everyone with [OAuth](http://oauth.net) access to any of my accounts
...
[Machine Learning](./img/wp-content-uploads-2012-05-machinelearning.gif)