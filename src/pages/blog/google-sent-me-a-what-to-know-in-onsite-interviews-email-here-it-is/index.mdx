...
redirect_from:
  - /blog/google-sent-me-a-what-to-know-in-on-site-interviews-email-here-it-is/swizec/4251
...
![An animation of the quicksort algorithm sortin...](https://upload.wikimedia.org/wikipedia/commons/6/6a/Sorting_quicksort_anim.gif "An animation of the quicksort algorithm sortin...")

They aldo sent me an email with advice. It can be summed up as _"You should know everything. If it's to do with computers, you should know it. Here are 5 books and 4 fancy algorithms you should read. You must also be intimately familiar with all these basic-ish algorithms. This is your two week notice. Good luck. Oh and take a look at these videos too!"_
...
[![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=f2e30d39-c798-4903-9421-69b1874e49e5)](http://www.zemanta.com/ "Enhanced by Zemanta")
