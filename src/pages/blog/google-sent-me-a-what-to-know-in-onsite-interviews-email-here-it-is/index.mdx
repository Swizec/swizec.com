...
![An animation of the quicksort algorithm sortin...](http://upload.wikimedia.org/wikipedia/commons/6/6a/Sorting_quicksort_anim.gif "An animation of the quicksort algorithm sortin...")
