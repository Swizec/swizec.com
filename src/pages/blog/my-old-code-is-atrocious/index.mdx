...
![Fixing others' code](./img/images-3841.png)
...
But man is it built out of some truly atrocious code. It started as a [Haskell](http://haskell.org) learning experiment over new year's break two years ago and, you know, back then I really thought I was a great engineer.
...
To make matters even more worse, I didn't use any libraries to talk to either [Toggl](http://www.toggl.com) or [Toshl](http://toshl.com/). Partly because Toshl only released an official API this summer and other than [my half baked attempt from two weeks ago](https://swizec.com/blog/about-achieving-polymorphism-in-javascript/) there are no libraries, partly because I don't know why.

The Toshl part is the worst. I fake user interactions to log into their service and export a [CSV file](http://en.wikipedia.org/wiki/Comma-separated_values) with data, then parse it locally.
...
![Enhanced by Zemanta](https://img.zemanta.com/zemified_e.png?x-id=36ac71d4-54e8-45d0-a899-64e537bd545a)
