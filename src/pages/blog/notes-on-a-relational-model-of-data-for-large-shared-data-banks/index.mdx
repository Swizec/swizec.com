...
Here's [a copy of the paper with my scribbles](https://swizec.com/blog/A%20relational%20model%20of%20data%20for%20large%20banks.pdf).
...
![Relational table from Wikipedia](https://upload.wikimedia.org/wikipedia/commons/8/8d/Relational_model_concepts.png)
...
[sparkjoy|notes-on-a-relational-model-of-data-for-large-shared-data-banks]
